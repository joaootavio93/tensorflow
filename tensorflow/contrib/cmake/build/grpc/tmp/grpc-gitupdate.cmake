...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref 781fd6f6ea03645a520cd5c675da67ab61f87e4b
  WORKING_DIRECTORY "C:/Visual Studio 2015/Projects/tensorflow/tensorflow/contrib/cmake/build/grpc/src/grpc"
...
if("${show_ref_output}" MATCHES "refs/remotes/781fd6f6ea03645a520cd5c675da67ab61f87e4b")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "781fd6f6ea03645a520cd5c675da67ab61f87e4b")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "781fd6f6ea03645a520cd5c675da67ab61f87e4b")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 781fd6f6ea03645a520cd5c675da67ab61f87e4b
  WORKING_DIRECTORY "C:/Visual Studio 2015/Projects/tensorflow/tensorflow/contrib/cmake/build/grpc/src/grpc"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Visual Studio 2015/Projects/tensorflow/tensorflow/contrib/cmake/build/grpc/src/grpc/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Visual Studio 2015/Projects/tensorflow/tensorflow/contrib/cmake/build/grpc/src/grpc/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "C:/Program Files/Git/cmd/git.exe" checkout 781fd6f6ea03645a520cd5c675da67ab61f87e4b
      WORKING_DIRECTORY "C:/Visual Studio 2015/Projects/tensorflow/tensorflow/contrib/cmake/build/grpc/src/grpc"
      RESULT_VARIABLE error_code
      )
    if(error_code)
