...
enum LearnerConfig_PruningMode {
  LearnerConfig_PruningMode_PRE_PRUNE = 0,
  LearnerConfig_PruningMode_POST_PRUNE = 1,
...
const LearnerConfig_PruningMode LearnerConfig_PruningMode_PruningMode_MIN = LearnerConfig_PruningMode_PRE_PRUNE;
...
enum LearnerConfig_GrowingMode {
  LearnerConfig_GrowingMode_WHOLE_TREE = 0,
  LearnerConfig_GrowingMode_LAYER_BY_LAYER = 1,
...
const LearnerConfig_GrowingMode LearnerConfig_GrowingMode_GrowingMode_MIN = LearnerConfig_GrowingMode_WHOLE_TREE;
...
enum LearnerConfig_MultiClassStrategy {
  LearnerConfig_MultiClassStrategy_TREE_PER_CLASS = 0,
  LearnerConfig_MultiClassStrategy_FULL_HESSIAN = 1,
  LearnerConfig_MultiClassStrategy_DIAGONAL_HESSIAN = 2,
...
const LearnerConfig_MultiClassStrategy LearnerConfig_MultiClassStrategy_MultiClassStrategy_MIN = LearnerConfig_MultiClassStrategy_TREE_PER_CLASS;
