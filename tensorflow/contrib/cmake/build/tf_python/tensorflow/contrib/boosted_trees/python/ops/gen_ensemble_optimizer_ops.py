...
def add_trees_to_ensemble(tree_ensemble_handle, ensemble_to_add, feature_column_usage_counts_handle, feature_column_usage_counts_to_add, feature_column_gains_handle, feature_column_gains_to_add, drop_out_tree_indices_weights, learning_rate, name=None):
  ...
  if _context.in_graph_mode():
    _, _, _op = _op_def_lib._apply_op_helper(
        "AddTreesToEnsemble", tree_ensemble_handle=tree_ensemble_handle,
    ...
    raise RuntimeError(
        "add_trees_to_ensemble op does not support eager execution.")
  return _result
