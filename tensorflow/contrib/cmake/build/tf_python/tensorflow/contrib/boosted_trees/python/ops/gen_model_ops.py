...
def create_tree_ensemble_variable(tree_ensemble_handle, stamp_token, tree_ensemble_config, name=None):
  ...
  if _context.in_graph_mode():
    ...
    tree_ensemble_config = _tensor.convert_to_eager_tensor(tree_ensemble_config, _dtypes.string)
    _inputs_flat = [tree_ensemble_handle, stamp_token, tree_ensemble_config]
    _attrs = None
    _result = _execute.execute("CreateTreeEnsembleVariable", 0,
...
def decision_tree_ensemble_resource_handle_op(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("DecisionTreeEnsembleResourceHandleOp", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
...
def tree_ensemble_deserialize(tree_ensemble_handle, stamp_token, tree_ensemble_config, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_ensemble_handle, stamp_token, tree_ensemble_config]
    _attrs = None
    _result = _execute.execute("TreeEnsembleDeserialize", 0,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  return _result
...
def tree_ensemble_is_initialized_op(tree_ensemble_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_ensemble_handle]
    _attrs = None
    _result = _execute.execute("TreeEnsembleIsInitializedOp", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def tree_ensemble_serialize(tree_ensemble_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_ensemble_handle]
    _attrs = None
    _result = _execute.execute("TreeEnsembleSerialize", 2,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def tree_ensemble_stamp_token(tree_ensemble_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_ensemble_handle]
    _attrs = None
    _result = _execute.execute("TreeEnsembleStampToken", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
