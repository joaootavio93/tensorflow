...
def create_stats_accumulator_scalar(stats_accumulator_handle, stamp_token, name=None):
  ...
  if _context.in_graph_mode():
    ...
    stats_accumulator_handle = _tensor.convert_to_eager_tensor(stats_accumulator_handle, _dtypes.resource)
    stamp_token = _tensor.convert_to_eager_tensor(stamp_token, _dtypes.int64)
    _inputs_flat = [stats_accumulator_handle, stamp_token]
    _attrs = None
    _result = _execute.execute("CreateStatsAccumulatorScalar", 0,
...
def create_stats_accumulator_tensor(stats_accumulator_handle, stamp_token, per_slot_gradient_shape, per_slot_hessian_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    stats_accumulator_handle = _tensor.convert_to_eager_tensor(stats_accumulator_handle, _dtypes.resource)
    stamp_token = _tensor.convert_to_eager_tensor(stamp_token, _dtypes.int64)
    per_slot_gradient_shape = _tensor.convert_to_eager_tensor(per_slot_gradient_shape, _dtypes.int64)
    per_slot_hessian_shape = _tensor.convert_to_eager_tensor(per_slot_hessian_shape, _dtypes.int64)
    _inputs_flat = [stats_accumulator_handle, stamp_token, per_slot_gradient_shape, per_slot_hessian_shape]
    _attrs = None
    _result = _execute.execute("CreateStatsAccumulatorTensor", 0,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  return _result
...
def stats_accumulator_scalar_add(stats_accumulator_handles, stamp_token, partition_ids, feature_ids, gradients, hessians, name=None):
  ...
  if _context.in_graph_mode():
    ...
    stats_accumulator_handles = _tensor.convert_n_to_eager_tensor(stats_accumulator_handles, _dtypes.resource)
    stamp_token = _tensor.convert_to_eager_tensor(stamp_token, _dtypes.int64)
    partition_ids = _tensor.convert_n_to_eager_tensor(partition_ids, _dtypes.int32)
    feature_ids = _tensor.convert_n_to_eager_tensor(feature_ids, _dtypes.int64)
    gradients = _tensor.convert_n_to_eager_tensor(gradients, _dtypes.float32)
    hessians = _tensor.convert_n_to_eager_tensor(hessians, _dtypes.float32)
    ...
    _result = _execute.execute("StatsAccumulatorScalarAdd", 0,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  return _result
...
def stats_accumulator_scalar_deserialize(stats_accumulator_handle, stamp_token, num_updates, partition_ids, feature_ids, gradients, hessians, name=None):
  ...
  if _context.in_graph_mode():
    ...
    stats_accumulator_handle = _tensor.convert_to_eager_tensor(stats_accumulator_handle, _dtypes.resource)
    stamp_token = _tensor.convert_to_eager_tensor(stamp_token, _dtypes.int64)
    num_updates = _tensor.convert_to_eager_tensor(num_updates, _dtypes.int64)
    partition_ids = _tensor.convert_to_eager_tensor(partition_ids, _dtypes.int32)
    feature_ids = _tensor.convert_to_eager_tensor(feature_ids, _dtypes.int64)
    gradients = _tensor.convert_to_eager_tensor(gradients, _dtypes.float32)
    hessians = _tensor.convert_to_eager_tensor(hessians, _dtypes.float32)
    _inputs_flat = [stats_accumulator_handle, stamp_token, num_updates, partition_ids, feature_ids, gradients, hessians]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorScalarDeserialize", 0,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  return _result
...
def stats_accumulator_scalar_flush(stats_accumulator_handle, stamp_token, next_stamp_token, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_accumulator_handle, stamp_token, next_stamp_token]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorScalarFlush", 5,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
...
def stats_accumulator_scalar_is_initialized(stats_accumulator_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_accumulator_handle]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorScalarIsInitialized", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_scalar_make_summary(partition_ids, feature_ids, gradients, hessians, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [partition_ids, feature_ids, gradients, hessians]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorScalarMakeSummary", 4,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_scalar_resource_handle_op(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("StatsAccumulatorScalarResourceHandleOp", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_scalar_serialize(stats_accumulator_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_accumulator_handle]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorScalarSerialize", 6,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_tensor_add(stats_accumulator_handles, stamp_token, partition_ids, feature_ids, gradients, hessians, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = list(stats_accumulator_handles) + [stamp_token] + list(partition_ids) + list(feature_ids) + list(gradients) + list(hessians)
    _attrs = ("num_resource_handles", _attr_num_resource_handles)
    _result = _execute.execute("StatsAccumulatorTensorAdd", 0,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  return _result
...
def stats_accumulator_tensor_deserialize(stats_accumulator_handle, stamp_token, num_updates, partition_ids, feature_ids, gradients, hessians, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_accumulator_handle, stamp_token, num_updates, partition_ids, feature_ids, gradients, hessians]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorTensorDeserialize", 0,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  return _result
...
def stats_accumulator_tensor_flush(stats_accumulator_handle, stamp_token, next_stamp_token, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_accumulator_handle, stamp_token, next_stamp_token]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorTensorFlush", 5,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_tensor_is_initialized(stats_accumulator_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_accumulator_handle]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorTensorIsInitialized", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_tensor_make_summary(partition_ids, feature_ids, gradients, hessians, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [partition_ids, feature_ids, gradients, hessians]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorTensorMakeSummary", 4,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_tensor_resource_handle_op(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = []
    _attrs = ("container", container, "shared_name", shared_name)
    _result = _execute.execute("StatsAccumulatorTensorResourceHandleOp", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stats_accumulator_tensor_serialize(stats_accumulator_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_accumulator_handle]
    _attrs = None
    _result = _execute.execute("StatsAccumulatorTensorSerialize", 6,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
