...
def cudnn_rnn(input, input_h, input_c, params, rnn_mode="lstm", input_mode="auto_select", direction="unidirectional", dropout=0, seed=0, seed2=0, is_training=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([input, input_h, input_c, params])
    ...
    _result = _execute.execute("CudnnRNN", 4, inputs=_inputs_flat,
...
def cudnn_rnn_backprop(input, input_h, input_c, params, output, output_h, output_c, output_backprop, output_h_backprop, output_c_backprop, reserve_space, rnn_mode="lstm", input_mode="auto_select", direction="unidirectional", dropout=0, seed=0, seed2=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([input, input_h, input_c, params, output, output_h, output_c, output_backprop, output_h_backprop, output_c_backprop, reserve_space])
    ...
    _attrs = ("T", _attr_T, "rnn_mode", rnn_mode, "input_mode", input_mode,
              "direction", direction, "dropout", dropout, "seed", seed,
              "seed2", seed2)
    _result = _execute.execute("CudnnRNNBackprop", 4, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def cudnn_rnn_canonical_to_params(num_layers, num_units, input_size, weights, biases, rnn_mode="lstm", input_mode="auto_select", direction="unidirectional", dropout=0, seed=0, seed2=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager(list(weights) + list(biases))
    _inputs_T = [_inputs_T[:_attr_num_params]] + _inputs_T[_attr_num_params:]
    _inputs_T = _inputs_T[:1] + [_inputs_T[1:]]
    (weights, biases) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    num_layers = _tensor.convert_to_eager_tensor(num_layers, _dtypes.int32)
    num_units = _tensor.convert_to_eager_tensor(num_units, _dtypes.int32)
    input_size = _tensor.convert_to_eager_tensor(input_size, _dtypes.int32)
    _inputs_flat = [num_layers, num_units, input_size] + list(weights) + list(biases)
    ...
    _result = _execute.execute("CudnnRNNCanonicalToParams", 1,
...
def cudnn_rnn_params_size(num_layers, num_units, input_size, T, S, rnn_mode="lstm", input_mode="auto_select", direction="unidirectional", dropout=0, seed=0, seed2=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", T, "S", S, "rnn_mode", rnn_mode, "input_mode", input_mode,
              "direction", direction, "dropout", dropout, "seed", seed,
              "seed2", seed2)
    _result = _execute.execute("CudnnRNNParamsSize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def cudnn_rnn_params_to_canonical(num_layers, num_units, input_size, params, num_params, rnn_mode="lstm", input_mode="auto_select", direction="unidirectional", dropout=0, seed=0, seed2=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (params,) = _execute.args_to_matching_eager([params])
    _attr_T = _attr_T.as_datatype_enum
    num_layers = _tensor.convert_to_eager_tensor(num_layers, _dtypes.int32)
    num_units = _tensor.convert_to_eager_tensor(num_units, _dtypes.int32)
    input_size = _tensor.convert_to_eager_tensor(input_size, _dtypes.int32)
    ...
    _result = _execute.execute("CudnnRNNParamsToCanonical", num_params +
