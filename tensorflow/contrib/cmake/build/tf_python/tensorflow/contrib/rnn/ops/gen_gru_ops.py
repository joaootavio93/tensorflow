...
def gru_block_cell(x, h_prev, w_ru, w_c, b_ru, b_c, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([x, h_prev, w_ru, w_c, b_ru, b_c])
    (x, h_prev, w_ru, w_c, b_ru, b_c) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [x, h_prev, w_ru, w_c, b_ru, b_c]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("GRUBlockCell", 4, inputs=_inputs_flat,
...
def gru_block_cell_grad(x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h])
    (x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("GRUBlockCellGrad", 4, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
