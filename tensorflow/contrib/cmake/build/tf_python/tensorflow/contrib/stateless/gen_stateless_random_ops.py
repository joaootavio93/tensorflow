...
def stateless_random_normal(shape, seed, dtype=_dtypes.float32, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (shape,) = _execute.args_to_matching_eager([shape], _dtypes.int32)
    _attr_T = _attr_T.as_datatype_enum
    seed = _tensor.convert_to_eager_tensor(seed, _dtypes.int64)
    _inputs_flat = [shape, seed]
    _attrs = ("dtype", dtype, "T", _attr_T)
    _result = _execute.execute("StatelessRandomNormal", 1,
...
def stateless_random_uniform(shape, seed, dtype=_dtypes.float32, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [shape, seed]
    _attrs = ("dtype", dtype, "T", _attr_T)
    _result = _execute.execute("StatelessRandomUniform", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stateless_truncated_normal(shape, seed, dtype=_dtypes.float32, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [shape, seed]
    _attrs = ("dtype", dtype, "T", _attr_T)
    _result = _execute.execute("StatelessTruncatedNormal", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
