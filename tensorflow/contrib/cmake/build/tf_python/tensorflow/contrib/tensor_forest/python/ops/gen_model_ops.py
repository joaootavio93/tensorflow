...
def create_tree_variable(tree_handle, tree_config, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    tree_handle = _tensor.convert_to_eager_tensor(tree_handle, _dtypes.resource)
    tree_config = _tensor.convert_to_eager_tensor(tree_config, _dtypes.string)
    _inputs_flat = [tree_handle, tree_config]
    _attrs = ("params", params)
    _result = _execute.execute("CreateTreeVariable", 0, inputs=_inputs_flat,
...
def decision_tree_resource_handle_op(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("DecisionTreeResourceHandleOp", 1,
...
def feature_usage_counts(tree_handle, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_handle]
    _attrs = ("params", params)
    _result = _execute.execute("FeatureUsageCounts", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def traverse_tree_v4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    tree_handle = _tensor.convert_to_eager_tensor(tree_handle, _dtypes.resource)
    input_data = _tensor.convert_to_eager_tensor(input_data, _dtypes.float32)
    sparse_input_indices = _tensor.convert_to_eager_tensor(sparse_input_indices, _dtypes.int64)
    sparse_input_values = _tensor.convert_to_eager_tensor(sparse_input_values, _dtypes.float32)
    sparse_input_shape = _tensor.convert_to_eager_tensor(sparse_input_shape, _dtypes.int64)
    _inputs_flat = [tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape]
    _attrs = ("input_spec", input_spec, "params", params)
    _result = _execute.execute("TraverseTreeV4", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def tree_deserialize(tree_handle, tree_config, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_handle, tree_config]
    _attrs = ("params", params)
    _result = _execute.execute("TreeDeserialize", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def tree_is_initialized_op(tree_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_handle]
    _attrs = None
    _result = _execute.execute("TreeIsInitializedOp", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def tree_predictions_v4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape]
    _attrs = ("input_spec", input_spec, "params", params)
    _result = _execute.execute("TreePredictionsV4", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def tree_serialize(tree_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_handle]
    _attrs = None
    _result = _execute.execute("TreeSerialize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def tree_size(tree_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [tree_handle]
    _attrs = None
    _result = _execute.execute("TreeSize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def update_model_v4(tree_handle, leaf_ids, input_labels, input_weights, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    tree_handle = _tensor.convert_to_eager_tensor(tree_handle, _dtypes.resource)
    leaf_ids = _tensor.convert_to_eager_tensor(leaf_ids, _dtypes.int32)
    input_labels = _tensor.convert_to_eager_tensor(input_labels, _dtypes.float32)
    input_weights = _tensor.convert_to_eager_tensor(input_weights, _dtypes.float32)
    _inputs_flat = [tree_handle, leaf_ids, input_labels, input_weights]
    _attrs = ("params", params)
    _result = _execute.execute("UpdateModelV4", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
