...
def create_fertile_stats_variable(stats_handle, stats_config, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    stats_handle = _tensor.convert_to_eager_tensor(stats_handle, _dtypes.resource)
    stats_config = _tensor.convert_to_eager_tensor(stats_config, _dtypes.string)
    _inputs_flat = [stats_handle, stats_config]
    _attrs = ("params", params)
    _result = _execute.execute("CreateFertileStatsVariable", 0,
...
def fertile_stats_deserialize(stats_handle, stats_config, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_handle, stats_config]
    _attrs = ("params", params)
    _result = _execute.execute("FertileStatsDeserialize", 0,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  return _result
...
def fertile_stats_is_initialized_op(stats_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_handle]
    _attrs = None
    _result = _execute.execute("FertileStatsIsInitializedOp", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
...
def fertile_stats_resource_handle_op(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("FertileStatsResourceHandleOp", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def fertile_stats_serialize(stats_handle, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [stats_handle]
    _attrs = ("params", params)
    _result = _execute.execute("FertileStatsSerialize", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def finalize_tree(tree_handle, stats_handle, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("params", params)
    _result = _execute.execute("FinalizeTree", 0, inputs=_inputs_flat,
...
def grow_tree_v4(tree_handle, stats_handle, finshed_nodes, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    tree_handle = _tensor.convert_to_eager_tensor(tree_handle, _dtypes.resource)
    stats_handle = _tensor.convert_to_eager_tensor(stats_handle, _dtypes.resource)
    finshed_nodes = _tensor.convert_to_eager_tensor(finshed_nodes, _dtypes.int32)
    _inputs_flat = [tree_handle, stats_handle, finshed_nodes]
    _attrs = ("params", params)
    _result = _execute.execute("GrowTreeV4", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def process_input_v4(tree_handle, stats_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_labels, input_weights, leaf_ids, random_seed, input_spec, params, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("random_seed", random_seed, "input_spec", input_spec, "params",
              params)
    _result = _execute.execute("ProcessInputV4", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
