...
def bitwise_and(x, y, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [x, y]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BitwiseAnd", 1, inputs=_inputs_flat,
...
def bitwise_or(x, y, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [x, y]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BitwiseOr", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def bitwise_xor(x, y, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [x, y]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BitwiseXor", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def invert(x, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [x]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Invert", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def population_count(x, name=None):
  ...
  **NOTE**: It is more efficient to first `tf.bitcast` your tensors into
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [x]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("PopulationCount", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
