...
def abort(error_msg="", exit_without_error=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("error_msg", error_msg, "exit_without_error",
              exit_without_error)
    _result = _execute.execute("Abort", 0, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  return _result
...
def control_trigger(name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = []
    _attrs = None
    _result = _execute.execute("ControlTrigger", 0, inputs=_inputs_flat,
...
def enter(data, frame_name, is_constant=False, parallel_iterations=10, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("Enter", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
...
def _exit(data, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [data]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Exit", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def loop_cond(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("LoopCond", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _merge(inputs, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("Merge", 2, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def next_iteration(data, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [data]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("NextIteration", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def no_op(name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = []
    _attrs = None
    _result = _execute.execute("NoOp", 0, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  return _result
...
def ref_enter(data, frame_name, is_constant=False, parallel_iterations=10, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "ref_enter op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _ref_exit(data, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "ref_exit op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _ref_merge(inputs, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "ref_merge op does not support eager execution.")
  _result = _execute.record_gradient(
...
def ref_next_iteration(data, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "ref_next_iteration op does not support eager execution.")
  _result = _execute.record_gradient(
...
def ref_select(index, inputs, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _op.outputs[:]
    _inputs_flat = [index] + list(inputs)
    _attrs = ("T", _op.get_attr("T"), "N", _op.get_attr("N"))
  else:
    raise RuntimeError(
        "ref_select op does not support eager execution.")
  _result = _execute.record_gradient(
...
def ref_switch(data, pred, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "ref_switch op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _switch(data, pred, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (data,) = _execute.args_to_matching_eager([data])
    _attr_T = _attr_T.as_datatype_enum
    pred = _tensor.convert_to_eager_tensor(pred, _dtypes.bool)
    _inputs_flat = [data, pred]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Switch", 2, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
