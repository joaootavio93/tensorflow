...
def accumulator_apply_gradient(handle, local_step, gradient, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "accumulator_apply_gradient op does not support eager execution.")
  return _result
...
def accumulator_num_accumulated(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "accumulator_num_accumulated op does not support eager execution.")
...
def accumulator_set_global_step(handle, new_global_step, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "accumulator_set_global_step op does not support eager execution.")
  return _result
...
def accumulator_take_gradient(handle, num_required, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "accumulator_take_gradient op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _barrier(component_types, shapes=[], capacity=-1, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "barrier op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _barrier_close(handle, cancel_pending_enqueues=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "barrier_close op does not support eager execution.")
  return _result
...
def _barrier_incomplete_size(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "barrier_incomplete_size op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _barrier_insert_many(handle, keys, values, component_index, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "barrier_insert_many op does not support eager execution.")
  return _result
...
def _barrier_ready_size(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "barrier_ready_size op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _barrier_take_many(handle, num_elements, component_types, allow_small_batch=False, wait_for_incomplete=False, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        name=name)
    _result = _op.outputs[:]
    _inputs_flat = [handle, num_elements]
    ...
    raise RuntimeError(
        "barrier_take_many op does not support eager execution.")
  _result = _execute.record_gradient(
...
def conditional_accumulator(dtype, shape, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "conditional_accumulator op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _delete_session_tensor(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    handle = _tensor.convert_to_eager_tensor(handle, _dtypes.string)
    _inputs_flat = [handle]
    _attrs = None
    _result = _execute.execute("DeleteSessionTensor", 0, inputs=_inputs_flat,
...
def dynamic_partition(data, partitions, num_partitions, name=None):
  ...
  if _context.in_graph_mode():
    ...
    partitions = _tensor.convert_to_eager_tensor(partitions, _dtypes.int32)
    _inputs_flat = [data, partitions]
    _attrs = ("num_partitions", num_partitions, "T", _attr_T)
    _result = _execute.execute("DynamicPartition", num_partitions,
...
def dynamic_stitch(indices, data, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, data = _execute.args_to_matching_eager(list(data))
    _attr_T = _attr_T.as_datatype_enum
    indices = _tensor.convert_n_to_eager_tensor(indices, _dtypes.int32)
    _inputs_flat = list(indices) + list(data)
    _attrs = ("N", _attr_N, "T", _attr_T)
    _result = _execute.execute("DynamicStitch", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _fifo_queue(component_types, shapes=[], capacity=-1, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "fifo_queue op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _fifo_queue_v2(component_types, shapes=[], capacity=-1, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("component_types", component_types, "shapes", shapes,
              ...
              shared_name)
    _result = _execute.execute("FIFOQueueV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _fake_queue(resource, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "fake_queue op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _get_session_handle(value, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [value]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("GetSessionHandle", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _get_session_handle_v2(value, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [value]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("GetSessionHandleV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _get_session_tensor(handle, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle]
    _attrs = ("dtype", dtype)
    _result = _execute.execute("GetSessionTensor", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def map_clear(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("MapClear", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def map_incomplete_size(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("MapIncompleteSize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def map_peek(key, indices, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    key = _tensor.convert_to_eager_tensor(key, _dtypes.int64)
    indices = _tensor.convert_to_eager_tensor(indices, _dtypes.int32)
    _inputs_flat = [key, indices]
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("MapPeek", len(dtypes), inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def map_size(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("MapSize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def map_stage(key, indices, values, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_fake_dtypes, values = _execute.convert_to_mixed_eager_tensors(values)
    ...
    _result = _execute.execute("MapStage", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def map_unstage(key, indices, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("MapUnstage", len(dtypes), inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def map_unstage_no_key(indices, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("MapUnstageNoKey", len(dtypes) + 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def ordered_map_clear(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("OrderedMapClear", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def ordered_map_incomplete_size(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("OrderedMapIncompleteSize", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def ordered_map_peek(key, indices, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("OrderedMapPeek", len(dtypes),
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def ordered_map_size(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("OrderedMapSize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def ordered_map_stage(key, indices, values, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "fake_dtypes", _attr_fake_dtypes, "container",
              container, "shared_name", shared_name)
    _result = _execute.execute("OrderedMapStage", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def ordered_map_unstage(key, indices, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("OrderedMapUnstage", len(dtypes),
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def ordered_map_unstage_no_key(indices, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("OrderedMapUnstageNoKey", len(dtypes) + 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _padding_fifo_queue(component_types, shapes=[], capacity=-1, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "padding_fifo_queue op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _padding_fifo_queue_v2(component_types, shapes=[], capacity=-1, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("component_types", component_types, "shapes", shapes,
              "capacity", capacity, "container", container, "shared_name",
              shared_name)
    _result = _execute.execute("PaddingFIFOQueueV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def parallel_dynamic_stitch(indices, data, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = list(indices) + list(data)
    _attrs = ("N", _attr_N, "T", _attr_T)
    _result = _execute.execute("ParallelDynamicStitch", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _priority_queue(shapes, component_types=[], capacity=-1, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "priority_queue op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _priority_queue_v2(shapes, component_types=[], capacity=-1, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("component_types", component_types, "shapes", shapes,
              "capacity", capacity, "container", container, "shared_name",
              shared_name)
    _result = _execute.execute("PriorityQueueV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _queue_close(handle, cancel_pending_enqueues=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_close op does not support eager execution.")
  return _result
...
def _queue_close_v2(handle, cancel_pending_enqueues=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    handle = _tensor.convert_to_eager_tensor(handle, _dtypes.resource)
    _inputs_flat = [handle]
    _attrs = ("cancel_pending_enqueues", cancel_pending_enqueues)
    _result = _execute.execute("QueueCloseV2", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def _queue_dequeue(handle, component_types, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_dequeue op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _queue_dequeue_many(handle, n, component_types, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_dequeue_many op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _queue_dequeue_many_v2(handle, n, component_types, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    handle = _tensor.convert_to_eager_tensor(handle, _dtypes.resource)
    n = _tensor.convert_to_eager_tensor(n, _dtypes.int32)
    _inputs_flat = [handle, n]
    _attrs = ("component_types", component_types, "timeout_ms", timeout_ms)
    _result = _execute.execute("QueueDequeueManyV2", len(component_types),
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _queue_dequeue_up_to(handle, n, component_types, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_dequeue_up_to op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _queue_dequeue_up_to_v2(handle, n, component_types, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, n]
    _attrs = ("component_types", component_types, "timeout_ms", timeout_ms)
    _result = _execute.execute("QueueDequeueUpToV2", len(component_types),
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _queue_dequeue_v2(handle, component_types, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle]
    _attrs = ("component_types", component_types, "timeout_ms", timeout_ms)
    _result = _execute.execute("QueueDequeueV2", len(component_types),
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _queue_enqueue(handle, components, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_enqueue op does not support eager execution.")
  return _result
...
def _queue_enqueue_many(handle, components, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_enqueue_many op does not support eager execution.")
  return _result
...
def _queue_enqueue_many_v2(handle, components, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_Tcomponents, components = _execute.convert_to_mixed_eager_tensors(components)
    ...
    _result = _execute.execute("QueueEnqueueManyV2", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def _queue_enqueue_v2(handle, components, timeout_ms=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle] + list(components)
    _attrs = ("Tcomponents", _attr_Tcomponents, "timeout_ms", timeout_ms)
    _result = _execute.execute("QueueEnqueueV2", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def queue_is_closed(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_is_closed op does not support eager execution.")
  _result = _execute.record_gradient(
...
def queue_is_closed_v2(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle]
    _attrs = None
    _result = _execute.execute("QueueIsClosedV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _queue_size(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "queue_size op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _queue_size_v2(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle]
    _attrs = None
    _result = _execute.execute("QueueSizeV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _random_shuffle_queue(component_types, shapes=[], capacity=-1, min_after_dequeue=0, seed=0, seed2=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "random_shuffle_queue op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _random_shuffle_queue_v2(component_types, shapes=[], capacity=-1, min_after_dequeue=0, seed=0, seed2=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("RandomShuffleQueueV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def record_input(file_pattern, file_random_seed=301, file_shuffle_shift_ratio=0, file_buffer_size=10000, file_parallelism=16, batch_size=32, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("RecordInput", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_accumulator_apply_gradient(handle, local_step, gradient_indices, gradient_values, gradient_shape, has_known_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "sparse_accumulator_apply_gradient op does not support eager execution.")
  return _result
...
def sparse_accumulator_take_gradient(handle, num_required, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "sparse_accumulator_take_gradient op does not support eager execution.")
  _result = _execute.record_gradient(
...
def sparse_conditional_accumulator(dtype, shape, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "sparse_conditional_accumulator op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _stack(elem_type, stack_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "stack op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _stack_close(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "stack_close op does not support eager execution.")
  return _result
...
def _stack_close_v2(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle]
    _attrs = None
    _result = _execute.execute("StackCloseV2", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def _stack_pop(handle, elem_type, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "stack_pop op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _stack_pop_v2(handle, elem_type, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("StackPopV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _stack_push(handle, elem, swap_memory=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "stack_push op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _stack_push_v2(handle, elem, swap_memory=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (elem,) = _execute.args_to_matching_eager([elem])
    _attr_T = _attr_T.as_datatype_enum
    handle = _tensor.convert_to_eager_tensor(handle, _dtypes.resource)
    _inputs_flat = [handle, elem]
    _attrs = ("T", _attr_T, "swap_memory", swap_memory)
    _result = _execute.execute("StackPushV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _stack_v2(max_size, elem_type, stack_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    max_size = _tensor.convert_to_eager_tensor(max_size, _dtypes.int32)
    _inputs_flat = [max_size]
    _attrs = ("elem_type", elem_type, "stack_name", stack_name)
    _result = _execute.execute("StackV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stage(values, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_dtypes, values = _execute.convert_to_mixed_eager_tensors(values)
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              ...
              shared_name)
    _result = _execute.execute("Stage", 0, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  return _result
...
def stage_clear(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("StageClear", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def stage_peek(index, dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    index = _tensor.convert_to_eager_tensor(index, _dtypes.int32)
    _inputs_flat = [index]
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("StagePeek", len(dtypes), inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def stage_size(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("StageSize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array(size, dtype, dynamic_size=False, clear_after_read=True, tensor_array_name="", element_shape=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_close(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_close op does not support eager execution.")
  return _result
...
def _tensor_array_close_v2(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle]
    _attrs = None
    _result = _execute.execute("TensorArrayCloseV2", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def _tensor_array_close_v3(handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle]
    _attrs = None
    _result = _execute.execute("TensorArrayCloseV3", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def _tensor_array_concat(handle, flow_in, dtype, element_shape_except0=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_concat op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_concat_v2(handle, flow_in, dtype, element_shape_except0=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    handle = _tensor.convert_to_eager_tensor(handle, _dtypes.string)
    flow_in = _tensor.convert_to_eager_tensor(flow_in, _dtypes.float32)
    _inputs_flat = [handle, flow_in]
    _attrs = ("dtype", dtype, "element_shape_except0", element_shape_except0)
    _result = _execute.execute("TensorArrayConcatV2", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_concat_v3(handle, flow_in, dtype, element_shape_except0=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, flow_in]
    _attrs = ("dtype", dtype, "element_shape_except0", element_shape_except0)
    _result = _execute.execute("TensorArrayConcatV3", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_gather(handle, indices, flow_in, dtype, element_shape=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_gather op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_gather_v2(handle, indices, flow_in, dtype, element_shape=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("TensorArrayGatherV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_gather_v3(handle, indices, flow_in, dtype, element_shape=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, indices, flow_in]
    _attrs = ("dtype", dtype, "element_shape", element_shape)
    _result = _execute.execute("TensorArrayGatherV3", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_grad(handle, flow_in, source, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_grad op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_grad_v2(handle, flow_in, source, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("TensorArrayGradV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_grad_v3(handle, flow_in, source, name=None):
  ...
  **A note about the source attribute:**
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, flow_in]
    _attrs = ("source", source)
    _result = _execute.execute("TensorArrayGradV3", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_pack(handle, flow_in, dtype, element_shape=None, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_pack op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_read(handle, index, flow_in, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_read op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_read_v2(handle, index, flow_in, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, index, flow_in]
    _attrs = ("dtype", dtype)
    _result = _execute.execute("TensorArrayReadV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_read_v3(handle, index, flow_in, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, index, flow_in]
    _attrs = ("dtype", dtype)
    _result = _execute.execute("TensorArrayReadV3", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_scatter(handle, indices, value, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_scatter op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_scatter_v2(handle, indices, value, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, indices, value, flow_in]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("TensorArrayScatterV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_scatter_v3(handle, indices, value, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, indices, value, flow_in]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("TensorArrayScatterV3", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_size(handle, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_size op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_size_v2(handle, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, flow_in]
    _attrs = None
    _result = _execute.execute("TensorArraySizeV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_size_v3(handle, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, flow_in]
    _attrs = None
    _result = _execute.execute("TensorArraySizeV3", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_split(handle, value, lengths, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_split op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_split_v2(handle, value, lengths, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T = _attr_T.as_datatype_enum
    handle = _tensor.convert_to_eager_tensor(handle, _dtypes.string)
    lengths = _tensor.convert_to_eager_tensor(lengths, _dtypes.int64)
    flow_in = _tensor.convert_to_eager_tensor(flow_in, _dtypes.float32)
    _inputs_flat = [handle, value, lengths, flow_in]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("TensorArraySplitV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_split_v3(handle, value, lengths, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, value, lengths, flow_in]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("TensorArraySplitV3", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_unpack(handle, value, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        name=name)
    _result = _op.outputs[:]
    _inputs_flat = [handle, value, flow_in]
    _attrs = ("T", _op.get_attr("T"))
  else:
    raise RuntimeError(
        "tensor_array_unpack op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_v2(size, dtype, element_shape=None, dynamic_size=False, clear_after_read=True, tensor_array_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("TensorArrayV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_v3(size, dtype, element_shape=None, dynamic_size=False, clear_after_read=True, tensor_array_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("dtype", dtype, "element_shape", element_shape, "dynamic_size",
              dynamic_size, "clear_after_read", clear_after_read,
              "tensor_array_name", tensor_array_name)
    _result = _execute.execute("TensorArrayV3", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_write(handle, index, value, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tensor_array_write op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tensor_array_write_v2(handle, index, value, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, index, value, flow_in]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("TensorArrayWriteV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_array_write_v3(handle, index, value, flow_in, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [handle, index, value, flow_in]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("TensorArrayWriteV3", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def unstage(dtypes, capacity=0, memory_limit=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("capacity", capacity, "memory_limit", memory_limit, "dtypes",
              dtypes, "container", container, "shared_name", shared_name)
    _result = _execute.execute("Unstage", len(dtypes), inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
