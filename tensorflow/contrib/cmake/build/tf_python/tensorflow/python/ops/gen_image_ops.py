...
def adjust_contrast(images, contrast_factor, min_value, max_value, name=None):
  ...
  if _context.in_graph_mode():
    ...
    contrast_factor = _tensor.convert_to_eager_tensor(contrast_factor, _dtypes.float32)
    min_value = _tensor.convert_to_eager_tensor(min_value, _dtypes.float32)
    max_value = _tensor.convert_to_eager_tensor(max_value, _dtypes.float32)
    _inputs_flat = [images, contrast_factor, min_value, max_value]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("AdjustContrast", 1, inputs=_inputs_flat,
...
def _adjust_contrastv2(images, contrast_factor, name=None):
  ...
  if _context.in_graph_mode():
    ...
    images = _tensor.convert_to_eager_tensor(images, _dtypes.float32)
    contrast_factor = _tensor.convert_to_eager_tensor(contrast_factor, _dtypes.float32)
    _inputs_flat = [images, contrast_factor]
    _attrs = None
    _result = _execute.execute("AdjustContrastv2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def adjust_hue(images, delta, name=None):
  ...
  if _context.in_graph_mode():
    ...
    images = _tensor.convert_to_eager_tensor(images, _dtypes.float32)
    delta = _tensor.convert_to_eager_tensor(delta, _dtypes.float32)
    _inputs_flat = [images, delta]
    _attrs = None
    _result = _execute.execute("AdjustHue", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def adjust_saturation(images, scale, name=None):
  ...
  if _context.in_graph_mode():
    ...
    images = _tensor.convert_to_eager_tensor(images, _dtypes.float32)
    scale = _tensor.convert_to_eager_tensor(scale, _dtypes.float32)
    _inputs_flat = [images, scale]
    _attrs = None
    _result = _execute.execute("AdjustSaturation", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def crop_and_resize(image, boxes, box_ind, crop_size, method="bilinear", extrapolation_value=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (image,) = _execute.args_to_matching_eager([image])
    _attr_T = _attr_T.as_datatype_enum
    boxes = _tensor.convert_to_eager_tensor(boxes, _dtypes.float32)
    box_ind = _tensor.convert_to_eager_tensor(box_ind, _dtypes.int32)
    crop_size = _tensor.convert_to_eager_tensor(crop_size, _dtypes.int32)
    _inputs_flat = [image, boxes, box_ind, crop_size]
    _attrs = ("T", _attr_T, "method", method, "extrapolation_value",
              extrapolation_value)
    _result = _execute.execute("CropAndResize", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def crop_and_resize_grad_boxes(grads, image, boxes, box_ind, method="bilinear", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (image,) = _execute.args_to_matching_eager([image])
    _attr_T = _attr_T.as_datatype_enum
    grads = _tensor.convert_to_eager_tensor(grads, _dtypes.float32)
    boxes = _tensor.convert_to_eager_tensor(boxes, _dtypes.float32)
    box_ind = _tensor.convert_to_eager_tensor(box_ind, _dtypes.int32)
    _inputs_flat = [grads, image, boxes, box_ind]
    _attrs = ("T", _attr_T, "method", method)
    _result = _execute.execute("CropAndResizeGradBoxes", 1,
...
def crop_and_resize_grad_image(grads, boxes, box_ind, image_size, T, method="bilinear", name=None):
  ...
  if _context.in_graph_mode():
    ...
    boxes = _tensor.convert_to_eager_tensor(boxes, _dtypes.float32)
    box_ind = _tensor.convert_to_eager_tensor(box_ind, _dtypes.int32)
    image_size = _tensor.convert_to_eager_tensor(image_size, _dtypes.int32)
    _inputs_flat = [grads, boxes, box_ind, image_size]
    _attrs = ("T", T, "method", method)
    _result = _execute.execute("CropAndResizeGradImage", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def decode_bmp(contents, channels=0, name=None):
  ...
  *   4: output an RGBA image.
  ...
  if _context.in_graph_mode():
    ...
    contents = _tensor.convert_to_eager_tensor(contents, _dtypes.string)
    _inputs_flat = [contents]
    _attrs = ("channels", channels)
    _result = _execute.execute("DecodeBmp", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def decode_gif(contents, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [contents]
    _attrs = None
    _result = _execute.execute("DecodeGif", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
  ...
  *   3: output an RGB image.
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("channels", channels, "ratio", ratio, "fancy_upscaling",
              ...
              dct_method)
    _result = _execute.execute("DecodeJpeg", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def decode_png(contents, channels=0, dtype=_dtypes.uint8, name=None):
  ...
  *   4: output an RGBA image.
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("DecodePng", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def draw_bounding_boxes(images, boxes, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (images,) = _execute.args_to_matching_eager([images], _dtypes.float32)
    _attr_T = _attr_T.as_datatype_enum
    boxes = _tensor.convert_to_eager_tensor(boxes, _dtypes.float32)
    _inputs_flat = [images, boxes]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("DrawBoundingBoxes", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def encode_jpeg(image, format="", quality=95, progressive=False, optimize_size=False, chroma_downsampling=True, density_unit="in", x_density=300, y_density=300, xmp_metadata="", name=None):
  ...
  *   3: Output an RGB image.
  ...
  if _context.in_graph_mode():
    ...
    image = _tensor.convert_to_eager_tensor(image, _dtypes.uint8)
    _inputs_flat = [image]
    ...
    _result = _execute.execute("EncodeJpeg", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def encode_png(image, compression=-1, name=None):
  ...
  *   4: for RGBA.
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (image,) = _execute.args_to_matching_eager([image], _dtypes.uint8)
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [image]
    _attrs = ("compression", compression, "T", _attr_T)
    _result = _execute.execute("EncodePng", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def extract_glimpse(input, size, offsets, centered=True, normalized=True, uniform_noise=True, name=None):
  ...
  * If the coordinates are not normalized they are interpreted as
  ...
  if _context.in_graph_mode():
    ...
    offsets = _tensor.convert_to_eager_tensor(offsets, _dtypes.float32)
    _inputs_flat = [input, size, offsets]
    _attrs = ("centered", centered, "normalized", normalized, "uniform_noise",
              uniform_noise)
    _result = _execute.execute("ExtractGlimpse", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def hsv_to_rgb(images, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [images]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("HSVToRGB", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _non_max_suppression(boxes, scores, max_output_size, iou_threshold=0.5, name=None):
  ...
  if _context.in_graph_mode():
    ...
    boxes = _tensor.convert_to_eager_tensor(boxes, _dtypes.float32)
    scores = _tensor.convert_to_eager_tensor(scores, _dtypes.float32)
    max_output_size = _tensor.convert_to_eager_tensor(max_output_size, _dtypes.int32)
    _inputs_flat = [boxes, scores, max_output_size]
    _attrs = ("iou_threshold", iou_threshold)
    _result = _execute.execute("NonMaxSuppression", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _non_max_suppression_v2(boxes, scores, max_output_size, iou_threshold, name=None):
  ...
  if _context.in_graph_mode():
    ...
    scores = _tensor.convert_to_eager_tensor(scores, _dtypes.float32)
    max_output_size = _tensor.convert_to_eager_tensor(max_output_size, _dtypes.int32)
    iou_threshold = _tensor.convert_to_eager_tensor(iou_threshold, _dtypes.float32)
    _inputs_flat = [boxes, scores, max_output_size, iou_threshold]
    _attrs = None
    _result = _execute.execute("NonMaxSuppressionV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_resize_bilinear(images, size, min, max, align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("QuantizedResizeBilinear", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def rgb_to_hsv(images, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [images]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("RGBToHSV", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _random_crop(image, size, seed=0, seed2=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("RandomCrop", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def resize_area(images, size, align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [images, size]
    _attrs = ("T", _attr_T, "align_corners", align_corners)
    _result = _execute.execute("ResizeArea", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def resize_bicubic(images, size, align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [images, size]
    _attrs = ("T", _attr_T, "align_corners", align_corners)
    _result = _execute.execute("ResizeBicubic", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def resize_bilinear(images, size, align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [images, size]
    _attrs = ("T", _attr_T, "align_corners", align_corners)
    _result = _execute.execute("ResizeBilinear", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _resize_bilinear_grad(grads, original_image, align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (original_image,) = _execute.args_to_matching_eager([original_image])
    _attr_T = _attr_T.as_datatype_enum
    grads = _tensor.convert_to_eager_tensor(grads, _dtypes.float32)
    _inputs_flat = [grads, original_image]
    _attrs = ("T", _attr_T, "align_corners", align_corners)
    _result = _execute.execute("ResizeBilinearGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def resize_nearest_neighbor(images, size, align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [images, size]
    _attrs = ("T", _attr_T, "align_corners", align_corners)
    _result = _execute.execute("ResizeNearestNeighbor", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _resize_nearest_neighbor_grad(grads, size, align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (grads,) = _execute.args_to_matching_eager([grads])
    _attr_T = _attr_T.as_datatype_enum
    size = _tensor.convert_to_eager_tensor(size, _dtypes.int32)
    _inputs_flat = [grads, size]
    _attrs = ("T", _attr_T, "align_corners", align_corners)
    _result = _execute.execute("ResizeNearestNeighborGrad", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sample_distorted_bounding_box(image_size, bounding_boxes, seed=0, seed2=0, min_object_covered=0.1, aspect_ratio_range=[0.75, 1.33], area_range=[0.05, 1], max_attempts=100, use_image_if_no_bounding_boxes=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (image_size,) = _execute.args_to_matching_eager([image_size])
    _attr_T = _attr_T.as_datatype_enum
    bounding_boxes = _tensor.convert_to_eager_tensor(bounding_boxes, _dtypes.float32)
    _inputs_flat = [image_size, bounding_boxes]
    _attrs = ("T", _attr_T, "seed", seed, "seed2", seed2,
    ...
    _result = _execute.execute("SampleDistortedBoundingBox", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sample_distorted_bounding_box_v2(image_size, bounding_boxes, min_object_covered, seed=0, seed2=0, aspect_ratio_range=[0.75, 1.33], area_range=[0.05, 1], max_attempts=100, use_image_if_no_bounding_boxes=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T = _attr_T.as_datatype_enum
    bounding_boxes = _tensor.convert_to_eager_tensor(bounding_boxes, _dtypes.float32)
    min_object_covered = _tensor.convert_to_eager_tensor(min_object_covered, _dtypes.float32)
    _inputs_flat = [image_size, bounding_boxes, min_object_covered]
    _attrs = ("T", _attr_T, "seed", seed, "seed2", seed2,
              ...
              "use_image_if_no_bounding_boxes",
              use_image_if_no_bounding_boxes)
    _result = _execute.execute("SampleDistortedBoundingBoxV2", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
