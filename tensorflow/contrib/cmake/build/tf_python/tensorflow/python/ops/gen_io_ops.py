...
def _fixed_length_record_reader(record_bytes, header_bytes=0, footer_bytes=0, hop_bytes=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "fixed_length_record_reader op does not support eager execution.")
...
def _fixed_length_record_reader_v2(record_bytes, header_bytes=0, footer_bytes=0, hop_bytes=0, container="", shared_name="", encoding="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("header_bytes", header_bytes, "record_bytes", record_bytes,
              ...
              encoding)
    _result = _execute.execute("FixedLengthRecordReaderV2", 1,
...
def _identity_reader(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "identity_reader op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _identity_reader_v2(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("IdentityReaderV2", 1, inputs=_inputs_flat,
...
def _lmdb_reader(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "lmdb_reader op does not support eager execution.")
  _result = _execute.record_gradient(
...
def matching_files(pattern, name=None):
  ...
  if _context.in_graph_mode():
    ...
    pattern = _tensor.convert_to_eager_tensor(pattern, _dtypes.string)
    _inputs_flat = [pattern]
    _attrs = None
    _result = _execute.execute("MatchingFiles", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def merge_v2_checkpoints(checkpoint_prefixes, destination_prefix, delete_old_dirs=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    checkpoint_prefixes = _tensor.convert_to_eager_tensor(checkpoint_prefixes, _dtypes.string)
    destination_prefix = _tensor.convert_to_eager_tensor(destination_prefix, _dtypes.string)
    _inputs_flat = [checkpoint_prefixes, destination_prefix]
    _attrs = ("delete_old_dirs", delete_old_dirs)
    _result = _execute.execute("MergeV2Checkpoints", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def read_file(filename, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [filename]
    _attrs = None
    _result = _execute.execute("ReadFile", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _reader_num_records_produced(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "reader_num_records_produced op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _reader_num_records_produced_v2(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    reader_handle = _tensor.convert_to_eager_tensor(reader_handle, _dtypes.resource)
    _inputs_flat = [reader_handle]
    _attrs = None
    _result = _execute.execute("ReaderNumRecordsProducedV2", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _reader_num_work_units_completed(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "reader_num_work_units_completed op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _reader_num_work_units_completed_v2(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [reader_handle]
    _attrs = None
    _result = _execute.execute("ReaderNumWorkUnitsCompletedV2", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _reader_read(reader_handle, queue_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "reader_read op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _reader_read_up_to(reader_handle, queue_handle, num_records, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "reader_read_up_to op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _reader_read_up_to_v2(reader_handle, queue_handle, num_records, name=None):
  ...
  if _context.in_graph_mode():
    ...
    reader_handle = _tensor.convert_to_eager_tensor(reader_handle, _dtypes.resource)
    queue_handle = _tensor.convert_to_eager_tensor(queue_handle, _dtypes.resource)
    num_records = _tensor.convert_to_eager_tensor(num_records, _dtypes.int64)
    _inputs_flat = [reader_handle, queue_handle, num_records]
    _attrs = None
    _result = _execute.execute("ReaderReadUpToV2", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _reader_read_v2(reader_handle, queue_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [reader_handle, queue_handle]
    _attrs = None
    _result = _execute.execute("ReaderReadV2", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _reader_reset(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "reader_reset op does not support eager execution.")
  return _result
...
def _reader_reset_v2(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [reader_handle]
    _attrs = None
    _result = _execute.execute("ReaderResetV2", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def _reader_restore_state(reader_handle, state, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "reader_restore_state op does not support eager execution.")
  return _result
...
def _reader_restore_state_v2(reader_handle, state, name=None):
  ...
  if _context.in_graph_mode():
    ...
    reader_handle = _tensor.convert_to_eager_tensor(reader_handle, _dtypes.resource)
    state = _tensor.convert_to_eager_tensor(state, _dtypes.string)
    _inputs_flat = [reader_handle, state]
    _attrs = None
    _result = _execute.execute("ReaderRestoreStateV2", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def _reader_serialize_state(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "reader_serialize_state op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _reader_serialize_state_v2(reader_handle, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [reader_handle]
    _attrs = None
    _result = _execute.execute("ReaderSerializeStateV2", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _restore(file_pattern, tensor_name, dt, preferred_shard=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    file_pattern = _tensor.convert_to_eager_tensor(file_pattern, _dtypes.string)
    tensor_name = _tensor.convert_to_eager_tensor(tensor_name, _dtypes.string)
    _inputs_flat = [file_pattern, tensor_name]
    _attrs = ("dt", dt, "preferred_shard", preferred_shard)
    _result = _execute.execute("Restore", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _restore_slice(file_pattern, tensor_name, shape_and_slice, dt, preferred_shard=-1, name=None):
  ...
  if _context.in_graph_mode():
    ...
    file_pattern = _tensor.convert_to_eager_tensor(file_pattern, _dtypes.string)
    tensor_name = _tensor.convert_to_eager_tensor(tensor_name, _dtypes.string)
    shape_and_slice = _tensor.convert_to_eager_tensor(shape_and_slice, _dtypes.string)
    _inputs_flat = [file_pattern, tensor_name, shape_and_slice]
    _attrs = ("dt", dt, "preferred_shard", preferred_shard)
    _result = _execute.execute("RestoreSlice", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def restore_v2(prefix, tensor_names, shape_and_slices, dtypes, name=None):
  ...
  if _context.in_graph_mode():
    ...
    prefix = _tensor.convert_to_eager_tensor(prefix, _dtypes.string)
    tensor_names = _tensor.convert_to_eager_tensor(tensor_names, _dtypes.string)
    shape_and_slices = _tensor.convert_to_eager_tensor(shape_and_slices, _dtypes.string)
    _inputs_flat = [prefix, tensor_names, shape_and_slices]
    _attrs = ("dtypes", dtypes)
    _result = _execute.execute("RestoreV2", len(dtypes), inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _save(filename, tensor_names, data, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, data = _execute.convert_to_mixed_eager_tensors(data)
    _attr_T = [_t.as_datatype_enum for _t in _attr_T]
    filename = _tensor.convert_to_eager_tensor(filename, _dtypes.string)
    tensor_names = _tensor.convert_to_eager_tensor(tensor_names, _dtypes.string)
    _inputs_flat = [filename, tensor_names] + list(data)
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Save", 0, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  return _result
...
def _save_slices(filename, tensor_names, shapes_and_slices, data, name=None):
  ...
  *  `start,length` where `start` and `length` are integers.  In that
  ...
  if _context.in_graph_mode():
    ...
    filename = _tensor.convert_to_eager_tensor(filename, _dtypes.string)
    tensor_names = _tensor.convert_to_eager_tensor(tensor_names, _dtypes.string)
    shapes_and_slices = _tensor.convert_to_eager_tensor(shapes_and_slices, _dtypes.string)
    _inputs_flat = [filename, tensor_names, shapes_and_slices] + list(data)
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SaveSlices", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def save_v2(prefix, tensor_names, shape_and_slices, tensors, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_dtypes, tensors = _execute.convert_to_mixed_eager_tensors(tensors)
    ...
    _result = _execute.execute("SaveV2", 0, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  return _result
...
def _sharded_filename(basename, shard, num_shards, name=None):
  ...
  if _context.in_graph_mode():
    ...
    basename = _tensor.convert_to_eager_tensor(basename, _dtypes.string)
    shard = _tensor.convert_to_eager_tensor(shard, _dtypes.int32)
    num_shards = _tensor.convert_to_eager_tensor(num_shards, _dtypes.int32)
    _inputs_flat = [basename, shard, num_shards]
    _attrs = None
    _result = _execute.execute("ShardedFilename", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sharded_filespec(basename, num_shards, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [basename, num_shards]
    _attrs = None
    _result = _execute.execute("ShardedFilespec", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tf_record_reader(container="", shared_name="", compression_type="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "tf_record_reader op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _tf_record_reader_v2(container="", shared_name="", compression_type="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("TFRecordReaderV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _text_line_reader(skip_header_lines=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "text_line_reader op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _text_line_reader_v2(skip_header_lines=0, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("TextLineReaderV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _whole_file_reader(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "whole_file_reader op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _whole_file_reader_v2(container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = []
    _attrs = ("container", container, "shared_name", shared_name)
    _result = _execute.execute("WholeFileReaderV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def write_file(filename, contents, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = None
    _result = _execute.execute("WriteFile", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
