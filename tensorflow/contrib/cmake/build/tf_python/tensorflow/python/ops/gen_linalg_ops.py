...
def _batch_cholesky(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BatchCholesky", 1, inputs=_inputs_flat,
...
def _batch_cholesky_grad(l, grad, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([l, grad])
    (l, grad) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [l, grad]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BatchCholeskyGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_matrix_determinant(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BatchMatrixDeterminant", 1,
...
def _batch_matrix_inverse(input, adjoint=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("BatchMatrixInverse", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_matrix_solve(matrix, rhs, adjoint=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([matrix, rhs])
    (matrix, rhs) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [matrix, rhs]
    _attrs = ("adjoint", adjoint, "T", _attr_T)
    _result = _execute.execute("BatchMatrixSolve", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_matrix_solve_ls(matrix, rhs, l2_regularizer, fast=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    (matrix, rhs) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    l2_regularizer = _tensor.convert_to_eager_tensor(l2_regularizer, _dtypes.float64)
    _inputs_flat = [matrix, rhs, l2_regularizer]
    _attrs = ("T", _attr_T, "fast", fast)
    _result = _execute.execute("BatchMatrixSolveLs", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_matrix_triangular_solve(matrix, rhs, lower=True, adjoint=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("BatchMatrixTriangularSolve", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_self_adjoint_eig(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BatchSelfAdjointEig", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_self_adjoint_eig_v2(input, compute_v=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("BatchSelfAdjointEigV2", 2,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_svd(input, compute_uv=True, full_matrices=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("compute_uv", compute_uv, "full_matrices", full_matrices, "T",
              _attr_T)
    _result = _execute.execute("BatchSvd", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def cholesky(input, name=None):
  ...
  **Note**: The gradient computation on GPU is faster for large matrices but
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Cholesky", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def cholesky_grad(l, grad, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [l, grad]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("CholeskyGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def matrix_determinant(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("MatrixDeterminant", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def matrix_inverse(input, adjoint=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("adjoint", adjoint, "T", _attr_T)
    _result = _execute.execute("MatrixInverse", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def matrix_solve(matrix, rhs, adjoint=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [matrix, rhs]
    _attrs = ("adjoint", adjoint, "T", _attr_T)
    _result = _execute.execute("MatrixSolve", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _matrix_solve_ls(matrix, rhs, l2_regularizer, fast=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [matrix, rhs, l2_regularizer]
    _attrs = ("T", _attr_T, "fast", fast)
    _result = _execute.execute("MatrixSolveLs", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def matrix_triangular_solve(matrix, rhs, lower=True, adjoint=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [matrix, rhs]
    _attrs = ("lower", lower, "adjoint", adjoint, "T", _attr_T)
    _result = _execute.execute("MatrixTriangularSolve", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def qr(input, full_matrices=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("Qr", 2, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _self_adjoint_eig(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SelfAdjointEig", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _self_adjoint_eig_v2(input, compute_v=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("compute_v", compute_v, "T", _attr_T)
    _result = _execute.execute("SelfAdjointEigV2", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _svd(input, compute_uv=True, full_matrices=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("compute_uv", compute_uv, "full_matrices", full_matrices, "T",
              _attr_T)
    _result = _execute.execute("Svd", 3, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
