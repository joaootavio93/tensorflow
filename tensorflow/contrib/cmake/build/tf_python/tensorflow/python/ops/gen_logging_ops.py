...
def _assert(condition, data, summarize=3, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("Assert", 0, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  return _result
...
def _audio_summary(tag, tensor, sample_rate, max_outputs=3, name=None):
  ...
  *  If `max_outputs` is greater than 1, the summary value tags are
  ...
  if _context.in_graph_mode():
    ...
    tag = _tensor.convert_to_eager_tensor(tag, _dtypes.string)
    tensor = _tensor.convert_to_eager_tensor(tensor, _dtypes.float32)
    _inputs_flat = [tag, tensor]
    _attrs = ("sample_rate", sample_rate, "max_outputs", max_outputs)
    _result = _execute.execute("AudioSummary", 1, inputs=_inputs_flat,
...
def _audio_summary_v2(tag, tensor, sample_rate, max_outputs=3, name=None):
  ...
  *  If `max_outputs` is greater than 1, the summary value tags are
  ...
  if _context.in_graph_mode():
    ...
    tag = _tensor.convert_to_eager_tensor(tag, _dtypes.string)
    tensor = _tensor.convert_to_eager_tensor(tensor, _dtypes.float32)
    sample_rate = _tensor.convert_to_eager_tensor(sample_rate, _dtypes.float32)
    _inputs_flat = [tag, tensor, sample_rate]
    _attrs = ("max_outputs", max_outputs)
    _result = _execute.execute("AudioSummaryV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _histogram_summary(tag, values, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (values,) = _execute.args_to_matching_eager([values], _dtypes.float32)
    _attr_T = _attr_T.as_datatype_enum
    tag = _tensor.convert_to_eager_tensor(tag, _dtypes.string)
    _inputs_flat = [tag, values]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("HistogramSummary", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _image_summary(tag, tensor, max_images=3, bad_color=_execute.make_tensor("""dtype: DT_UINT8 tensor_shape { dim { size: 4 } } int_val: 255 int_val: 0 int_val: 0 int_val: 255""", "bad_color"), name=None):
  ...
  *  If `max_images` is greater than 1, the summary value tags are
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (tensor,) = _execute.args_to_matching_eager([tensor], _dtypes.float32)
    _attr_T = _attr_T.as_datatype_enum
    tag = _tensor.convert_to_eager_tensor(tag, _dtypes.string)
    _inputs_flat = [tag, tensor]
    _attrs = ("max_images", max_images, "T", _attr_T, "bad_color", bad_color)
    _result = _execute.execute("ImageSummary", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _merge_summary(inputs, name=None):
  ...
  if _context.in_graph_mode():
    ...
    inputs = _tensor.convert_n_to_eager_tensor(inputs, _dtypes.string)
    _inputs_flat = list(inputs)
    _attrs = ("N", _attr_N)
    _result = _execute.execute("MergeSummary", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _print(input, data, message="", first_n=-1, summarize=3, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T = _attr_T.as_datatype_enum
    _attr_U, data = _execute.convert_to_mixed_eager_tensors(data)
    ...
    _result = _execute.execute("Print", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _scalar_summary(tags, values, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T = _attr_T.as_datatype_enum
    tags = _tensor.convert_to_eager_tensor(tags, _dtypes.string)
    _inputs_flat = [tags, values]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("ScalarSummary", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_summary(tensor, description="", labels=[], display_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("TensorSummary", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _tensor_summary_v2(tag, tensor, serialized_summary_metadata, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T = _attr_T.as_datatype_enum
    tag = _tensor.convert_to_eager_tensor(tag, _dtypes.string)
    serialized_summary_metadata = _tensor.convert_to_eager_tensor(serialized_summary_metadata, _dtypes.string)
    _inputs_flat = [tag, tensor, serialized_summary_metadata]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("TensorSummaryV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
