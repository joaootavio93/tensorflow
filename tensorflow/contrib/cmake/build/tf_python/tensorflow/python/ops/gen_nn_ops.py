...
def _avg_pool(value, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("AvgPool", 1, inputs=_inputs_flat,
...
def avg_pool3d(input, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("AvgPool3D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _avg_pool3d_grad(orig_input_shape, grad, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T = _attr_T.as_datatype_enum
    orig_input_shape = _tensor.convert_to_eager_tensor(orig_input_shape, _dtypes.int32)
    _inputs_flat = [orig_input_shape, grad]
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("AvgPool3DGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _avg_pool_grad(orig_input_shape, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("AvgPoolGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_norm_with_global_normalization(t, m, v, beta, gamma, variance_epsilon, scale_after_normalization, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([t, m, v, beta, gamma])
    (t, m, v, beta, gamma) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [t, m, v, beta, gamma]
    _attrs = ("T", _attr_T, "variance_epsilon", variance_epsilon,
              "scale_after_normalization", scale_after_normalization)
    _result = _execute.execute("BatchNormWithGlobalNormalization", 1,
...
def _batch_norm_with_global_normalization_grad(t, m, v, gamma, backprop, variance_epsilon, scale_after_normalization, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([t, m, v, gamma, backprop])
    (t, m, v, gamma, backprop) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [t, m, v, gamma, backprop]
    _attrs = ("T", _attr_T, "variance_epsilon", variance_epsilon,
              "scale_after_normalization", scale_after_normalization)
    _result = _execute.execute("BatchNormWithGlobalNormalizationGrad", 5,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _bias_add(value, bias, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([value, bias])
    (value, bias) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [value, bias]
    _attrs = ("T", _attr_T, "data_format", data_format)
    _result = _execute.execute("BiasAdd", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def bias_add_grad(out_backprop, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (out_backprop,) = _execute.args_to_matching_eager([out_backprop])
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [out_backprop]
    _attrs = ("T", _attr_T, "data_format", data_format)
    _result = _execute.execute("BiasAddGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _bias_add_v1(value, bias, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [value, bias]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("BiasAddV1", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def conv2d(input, filter, strides, padding, use_cudnn_on_gpu=True, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([input, filter])
    ...
    _attrs = ("T", _attr_T, "strides", strides, "use_cudnn_on_gpu",
              ...
              data_format)
    _result = _execute.execute("Conv2D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def conv2d_backprop_filter(input, filter_sizes, out_backprop, strides, padding, use_cudnn_on_gpu=True, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([input, out_backprop])
    (input, out_backprop) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    filter_sizes = _tensor.convert_to_eager_tensor(filter_sizes, _dtypes.int32)
    _inputs_flat = [input, filter_sizes, out_backprop]
    _attrs = ("T", _attr_T, "strides", strides, "use_cudnn_on_gpu",
              use_cudnn_on_gpu, "padding", padding, "data_format",
              data_format)
    _result = _execute.execute("Conv2DBackpropFilter", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def conv2d_backprop_input(input_sizes, filter, out_backprop, strides, padding, use_cudnn_on_gpu=True, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([filter, out_backprop])
    (filter, out_backprop) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    input_sizes = _tensor.convert_to_eager_tensor(input_sizes, _dtypes.int32)
    _inputs_flat = [input_sizes, filter, out_backprop]
    _attrs = ("T", _attr_T, "strides", strides, "use_cudnn_on_gpu",
              use_cudnn_on_gpu, "padding", padding, "data_format",
              data_format)
    _result = _execute.execute("Conv2DBackpropInput", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def conv3d(input, filter, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("Conv3D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def conv3d_backprop_filter(input, filter, out_backprop, strides, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([input, filter, out_backprop])
    (input, filter, out_backprop) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [input, filter, out_backprop]
    _attrs = ("T", _attr_T, "strides", strides, "padding", padding)
    _result = _execute.execute("Conv3DBackpropFilter", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def conv3d_backprop_filter_v2(input, filter_sizes, out_backprop, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "padding", padding,
              "data_format", data_format)
    _result = _execute.execute("Conv3DBackpropFilterV2", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def conv3d_backprop_input(input, filter, out_backprop, strides, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input, filter, out_backprop]
    _attrs = ("T", _attr_T, "strides", strides, "padding", padding)
    _result = _execute.execute("Conv3DBackpropInput", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def conv3d_backprop_input_v2(input_sizes, filter, out_backprop, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "padding", padding,
              "data_format", data_format)
    _result = _execute.execute("Conv3DBackpropInputV2", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def depthwise_conv2d_native(input, filter, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "padding", padding,
              "data_format", data_format)
    _result = _execute.execute("DepthwiseConv2dNative", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def depthwise_conv2d_native_backprop_filter(input, filter_sizes, out_backprop, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "padding", padding,
              "data_format", data_format)
    _result = _execute.execute("DepthwiseConv2dNativeBackpropFilter", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def depthwise_conv2d_native_backprop_input(input_sizes, filter, out_backprop, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "padding", padding,
              "data_format", data_format)
    _result = _execute.execute("DepthwiseConv2dNativeBackpropInput", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def dilation2d(input, filter, strides, rates, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "rates", rates, "padding",
              padding)
    _result = _execute.execute("Dilation2D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def dilation2d_backprop_filter(input, filter, out_backprop, strides, rates, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "rates", rates, "padding",
              padding)
    _result = _execute.execute("Dilation2DBackpropFilter", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def dilation2d_backprop_input(input, filter, out_backprop, strides, rates, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "strides", strides, "rates", rates, "padding",
              padding)
    _result = _execute.execute("Dilation2DBackpropInput", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def elu(features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (features,) = _execute.args_to_matching_eager([features])
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Elu", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _elu_grad(gradients, outputs, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, outputs])
    (gradients, outputs) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [gradients, outputs]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("EluGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def fractional_avg_pool(value, pooling_ratio, pseudo_random=False, overlapping=False, deterministic=False, seed=0, seed2=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("FractionalAvgPool", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _fractional_avg_pool_grad(orig_input_tensor_shape, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (out_backprop,) = _execute.args_to_matching_eager([out_backprop])
    _attr_T = _attr_T.as_datatype_enum
    orig_input_tensor_shape = _tensor.convert_to_eager_tensor(orig_input_tensor_shape, _dtypes.int64)
    row_pooling_sequence = _tensor.convert_to_eager_tensor(row_pooling_sequence, _dtypes.int64)
    col_pooling_sequence = _tensor.convert_to_eager_tensor(col_pooling_sequence, _dtypes.int64)
    _inputs_flat = [orig_input_tensor_shape, out_backprop, row_pooling_sequence, col_pooling_sequence]
    _attrs = ("overlapping", overlapping, "T", _attr_T)
    _result = _execute.execute("FractionalAvgPoolGrad", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def fractional_max_pool(value, pooling_ratio, pseudo_random=False, overlapping=False, deterministic=False, seed=0, seed2=0, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("pooling_ratio", pooling_ratio, "pseudo_random", pseudo_random,
              "overlapping", overlapping, "deterministic", deterministic,
              "seed", seed, "seed2", seed2, "T", _attr_T)
    _result = _execute.execute("FractionalMaxPool", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _fractional_max_pool_grad(orig_input, orig_output, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([orig_input, orig_output, out_backprop])
    ...
    _inputs_flat = [orig_input, orig_output, out_backprop, row_pooling_sequence, col_pooling_sequence]
    _attrs = ("overlapping", overlapping, "T", _attr_T)
    _result = _execute.execute("FractionalMaxPoolGrad", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _fused_batch_norm(x, scale, offset, mean, variance, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([x, scale, offset, mean, variance])
    (x, scale, offset, mean, variance) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [x, scale, offset, mean, variance]
    _attrs = ("T", _attr_T, "epsilon", epsilon, "data_format", data_format,
              "is_training", is_training)
    _result = _execute.execute("FusedBatchNorm", 5, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def fused_batch_norm_grad(y_backprop, x, scale, reserve_space_1, reserve_space_2, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([y_backprop, x, scale, reserve_space_1, reserve_space_2])
    (y_backprop, x, scale, reserve_space_1, reserve_space_2) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [y_backprop, x, scale, reserve_space_1, reserve_space_2]
    _attrs = ("T", _attr_T, "epsilon", epsilon, "data_format", data_format,
              "is_training", is_training)
    _result = _execute.execute("FusedBatchNormGrad", 5, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def fused_pad_conv2d(input, paddings, filter, mode, strides, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    (input, filter) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    paddings = _tensor.convert_to_eager_tensor(paddings, _dtypes.int32)
    _inputs_flat = [input, paddings, filter]
    _attrs = ("T", _attr_T, "mode", mode, "strides", strides, "padding",
              padding)
    _result = _execute.execute("FusedPadConv2D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def fused_resize_and_pad_conv2d(input, size, paddings, filter, mode, strides, padding, resize_align_corners=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("FusedResizeAndPadConv2D", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _in_top_k(predictions, targets, k, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (targets,) = _execute.args_to_matching_eager([targets], _dtypes.int32)
    _attr_T = _attr_T.as_datatype_enum
    predictions = _tensor.convert_to_eager_tensor(predictions, _dtypes.float32)
    _inputs_flat = [predictions, targets]
    _attrs = ("k", k, "T", _attr_T)
    _result = _execute.execute("InTopK", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _in_top_kv2(predictions, targets, k, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([targets, k], _dtypes.int32)
    (targets, k) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    predictions = _tensor.convert_to_eager_tensor(predictions, _dtypes.float32)
    _inputs_flat = [predictions, targets, k]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("InTopKV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def l2_loss(t, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (t,) = _execute.args_to_matching_eager([t])
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [t]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("L2Loss", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def lrn(input, depth_radius=5, bias=1, alpha=1, beta=0.5, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (input,) = _execute.args_to_matching_eager([input], _dtypes.float32)
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [input]
    _attrs = ("depth_radius", depth_radius, "bias", bias, "alpha", alpha,
              "beta", beta, "T", _attr_T)
    _result = _execute.execute("LRN", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _lrn_grad(input_grads, input_image, output_image, depth_radius=5, bias=1, alpha=1, beta=0.5, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([input_grads, input_image, output_image], _dtypes.float32)
    (input_grads, input_image, output_image) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [input_grads, input_image, output_image]
    _attrs = ("depth_radius", depth_radius, "bias", bias, "alpha", alpha,
              "beta", beta, "T", _attr_T)
    _result = _execute.execute("LRNGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _log_softmax(logits, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [logits]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("LogSoftmax", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool(input, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("MaxPool", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def max_pool3d(input, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("MaxPool3D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool3d_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (grad,) = _execute.args_to_matching_eager([grad], _dtypes.float32)
    _attr_T = _attr_T.as_datatype_enum
    _attr_TInput, _inputs_TInput = _execute.args_to_matching_eager([orig_input, orig_output], _dtypes.float32)
    ...
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              ...
              _attr_TInput)
    _result = _execute.execute("MaxPool3DGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool3d_grad_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([orig_input, orig_output, grad])
    (orig_input, orig_output, grad) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [orig_input, orig_output, grad]
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("MaxPool3DGradGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([orig_input, orig_output, grad], _dtypes.float32)
    (orig_input, orig_output, grad) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [orig_input, orig_output, grad]
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("MaxPoolGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool_grad_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("MaxPoolGradGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def max_pool_grad_grad_v2(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    (orig_input, orig_output, grad) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    ksize = _tensor.convert_to_eager_tensor(ksize, _dtypes.int32)
    strides = _tensor.convert_to_eager_tensor(strides, _dtypes.int32)
    _inputs_flat = [orig_input, orig_output, grad, ksize, strides]
    _attrs = ("padding", padding, "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("MaxPoolGradGradV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool_grad_grad_with_argmax(input, grad, argmax, ksize, strides, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_Targmax, (argmax,) = _execute.args_to_matching_eager([argmax])
    _attr_Targmax = _attr_Targmax.as_datatype_enum
    _attr_T, _inputs_T = _execute.args_to_matching_eager([input, grad])
    (input, grad) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [input, grad, argmax]
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "Targmax", _attr_Targmax, "T", _attr_T)
    _result = _execute.execute("MaxPoolGradGradWithArgmax", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def max_pool_grad_v2(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [orig_input, orig_output, grad, ksize, strides]
    _attrs = ("padding", padding, "data_format", data_format, "T", _attr_T)
    _result = _execute.execute("MaxPoolGradV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool_grad_with_argmax(input, grad, argmax, ksize, strides, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
              "Targmax", _attr_Targmax, "T", _attr_T)
    _result = _execute.execute("MaxPoolGradWithArgmax", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _max_pool_v2(input, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("MaxPoolV2", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def max_pool_with_argmax(input, ksize, strides, padding, Targmax=_dtypes.int64, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("MaxPoolWithArgmax", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_avg_pool(input, min_input, max_input, ksize, strides, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (input,) = _execute.args_to_matching_eager([input])
    _attr_T = _attr_T.as_datatype_enum
    min_input = _tensor.convert_to_eager_tensor(min_input, _dtypes.float32)
    max_input = _tensor.convert_to_eager_tensor(max_input, _dtypes.float32)
    _inputs_flat = [input, min_input, max_input]
    _attrs = ("T", _attr_T, "ksize", ksize, "strides", strides, "padding",
              padding)
    _result = _execute.execute("QuantizedAvgPool", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_batch_norm_with_global_normalization(t, t_min, t_max, m, m_min, m_max, v, v_min, v_max, beta, beta_min, beta_max, gamma, gamma_min, gamma_max, out_type, variance_epsilon, scale_after_normalization, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_Tinput, _inputs_Tinput = _execute.args_to_matching_eager([t, m, v, beta, gamma])
    (t, m, v, beta, gamma) = _inputs_Tinput
    _attr_Tinput = _attr_Tinput.as_datatype_enum
    t_min = _tensor.convert_to_eager_tensor(t_min, _dtypes.float32)
    t_max = _tensor.convert_to_eager_tensor(t_max, _dtypes.float32)
    m_min = _tensor.convert_to_eager_tensor(m_min, _dtypes.float32)
    m_max = _tensor.convert_to_eager_tensor(m_max, _dtypes.float32)
    v_min = _tensor.convert_to_eager_tensor(v_min, _dtypes.float32)
    v_max = _tensor.convert_to_eager_tensor(v_max, _dtypes.float32)
    beta_min = _tensor.convert_to_eager_tensor(beta_min, _dtypes.float32)
    beta_max = _tensor.convert_to_eager_tensor(beta_max, _dtypes.float32)
    gamma_min = _tensor.convert_to_eager_tensor(gamma_min, _dtypes.float32)
    gamma_max = _tensor.convert_to_eager_tensor(gamma_max, _dtypes.float32)
    _inputs_flat = [t, t_min, t_max, m, m_min, m_max, v, v_min, v_max, beta, beta_min, beta_max, gamma, gamma_min, gamma_max]
    _attrs = ("Tinput", _attr_Tinput, "out_type", out_type,
              "variance_epsilon", variance_epsilon,
              "scale_after_normalization", scale_after_normalization)
    _result = _execute.execute("QuantizedBatchNormWithGlobalNormalization", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_bias_add(input, bias, min_input, max_input, min_bias, max_bias, out_type, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T1, (input,) = _execute.args_to_matching_eager([input])
    _attr_T1 = _attr_T1.as_datatype_enum
    _attr_T2, (bias,) = _execute.args_to_matching_eager([bias])
    _attr_T2 = _attr_T2.as_datatype_enum
    min_input = _tensor.convert_to_eager_tensor(min_input, _dtypes.float32)
    max_input = _tensor.convert_to_eager_tensor(max_input, _dtypes.float32)
    min_bias = _tensor.convert_to_eager_tensor(min_bias, _dtypes.float32)
    max_bias = _tensor.convert_to_eager_tensor(max_bias, _dtypes.float32)
    _inputs_flat = [input, bias, min_input, max_input, min_bias, max_bias]
    _attrs = ("T1", _attr_T1, "T2", _attr_T2, "out_type", out_type)
    _result = _execute.execute("QuantizedBiasAdd", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_conv2d(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_Tinput = _attr_Tinput.as_datatype_enum
    _attr_Tfilter, (filter,) = _execute.args_to_matching_eager([filter])
    _attr_Tfilter = _attr_Tfilter.as_datatype_enum
    min_input = _tensor.convert_to_eager_tensor(min_input, _dtypes.float32)
    max_input = _tensor.convert_to_eager_tensor(max_input, _dtypes.float32)
    min_filter = _tensor.convert_to_eager_tensor(min_filter, _dtypes.float32)
    max_filter = _tensor.convert_to_eager_tensor(max_filter, _dtypes.float32)
    _inputs_flat = [input, filter, min_input, max_input, min_filter, max_filter]
    _attrs = ("Tinput", _attr_Tinput, "Tfilter", _attr_Tfilter, "out_type",
              out_type, "strides", strides, "padding", padding)
    _result = _execute.execute("QuantizedConv2D", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_max_pool(input, min_input, max_input, ksize, strides, padding, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "ksize", ksize, "strides", strides, "padding",
              padding)
    _result = _execute.execute("QuantizedMaxPool", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_relu(features, min_features, max_features, out_type=_dtypes.quint8, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_Tinput, (features,) = _execute.args_to_matching_eager([features])
    _attr_Tinput = _attr_Tinput.as_datatype_enum
    min_features = _tensor.convert_to_eager_tensor(min_features, _dtypes.float32)
    max_features = _tensor.convert_to_eager_tensor(max_features, _dtypes.float32)
    _inputs_flat = [features, min_features, max_features]
    _attrs = ("Tinput", _attr_Tinput, "out_type", out_type)
    _result = _execute.execute("QuantizedRelu", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_relu6(features, min_features, max_features, out_type=_dtypes.quint8, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [features, min_features, max_features]
    _attrs = ("Tinput", _attr_Tinput, "out_type", out_type)
    _result = _execute.execute("QuantizedRelu6", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def quantized_relu_x(features, max_value, min_features, max_features, out_type=_dtypes.quint8, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_Tinput, (features,) = _execute.args_to_matching_eager([features])
    _attr_Tinput = _attr_Tinput.as_datatype_enum
    max_value = _tensor.convert_to_eager_tensor(max_value, _dtypes.float32)
    min_features = _tensor.convert_to_eager_tensor(min_features, _dtypes.float32)
    max_features = _tensor.convert_to_eager_tensor(max_features, _dtypes.float32)
    _inputs_flat = [features, max_value, min_features, max_features]
    _attrs = ("Tinput", _attr_Tinput, "out_type", out_type)
    _result = _execute.execute("QuantizedReluX", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def relu(features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Relu", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _relu6(features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Relu6", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _relu6_grad(gradients, features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, features])
    (gradients, features) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [gradients, features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Relu6Grad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _relu_grad(gradients, features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [gradients, features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("ReluGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def selu(features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Selu", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _selu_grad(gradients, outputs, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [gradients, outputs]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SeluGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _softmax(logits, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [logits]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Softmax", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _softmax_cross_entropy_with_logits(features, labels, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([features, labels])
    (features, labels) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [features, labels]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SoftmaxCrossEntropyWithLogits", 2,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def softplus(features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Softplus", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _softplus_grad(gradients, features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [gradients, features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SoftplusGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def softsign(features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Softsign", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _softsign_grad(gradients, features, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [gradients, features]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SoftsignGrad", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_softmax_cross_entropy_with_logits(features, labels, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (features,) = _execute.args_to_matching_eager([features])
    _attr_T = _attr_T.as_datatype_enum
    _attr_Tlabels, (labels,) = _execute.args_to_matching_eager([labels], _dtypes.int64)
    _attr_Tlabels = _attr_Tlabels.as_datatype_enum
    _inputs_flat = [features, labels]
    _attrs = ("T", _attr_T, "Tlabels", _attr_Tlabels)
    _result = _execute.execute("SparseSoftmaxCrossEntropyWithLogits", 2,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _top_k(input, k, sorted=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("TopK", 2, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def _top_kv2(input, k, sorted=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (input,) = _execute.args_to_matching_eager([input])
    _attr_T = _attr_T.as_datatype_enum
    k = _tensor.convert_to_eager_tensor(k, _dtypes.int32)
    _inputs_flat = [input, k]
    _attrs = ("sorted", sorted, "T", _attr_T)
    _result = _execute.execute("TopKV2", 2, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
