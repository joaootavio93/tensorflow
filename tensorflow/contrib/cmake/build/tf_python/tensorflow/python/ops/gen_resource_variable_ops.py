...
def assign_add_variable_op(resource, value, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_dtype, (value,) = _execute.args_to_matching_eager([value])
    _attr_dtype = _attr_dtype.as_datatype_enum
    resource = _tensor.convert_to_eager_tensor(resource, _dtypes.resource)
    _inputs_flat = [resource, value]
    _attrs = ("dtype", _attr_dtype)
    _result = _execute.execute("AssignAddVariableOp", 0, inputs=_inputs_flat,
...
def assign_sub_variable_op(resource, value, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [resource, value]
    _attrs = ("dtype", _attr_dtype)
    _result = _execute.execute("AssignSubVariableOp", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def assign_variable_op(resource, value, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [resource, value]
    _attrs = ("dtype", _attr_dtype)
    _result = _execute.execute("AssignVariableOp", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def destroy_resource_op(resource, ignore_lookup_error=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("DestroyResourceOp", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def read_variable_op(resource, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [resource]
    _attrs = ("dtype", dtype)
    _result = _execute.execute("ReadVariableOp", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
...
def resource_gather(resource, indices, dtype, validate_indices=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("ResourceGather", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def resource_scatter_add(resource, indices, updates, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_dtype, (updates,) = _execute.args_to_matching_eager([updates])
    _attr_dtype = _attr_dtype.as_datatype_enum
    _attr_Tindices, (indices,) = _execute.args_to_matching_eager([indices])
    _attr_Tindices = _attr_Tindices.as_datatype_enum
    resource = _tensor.convert_to_eager_tensor(resource, _dtypes.resource)
    ...
    _result = _execute.execute("ResourceScatterAdd", 0, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  return _result
...
def var_handle_op(dtype, shape, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("container", container, "shared_name", shared_name, "dtype",
              dtype, "shape", shape)
    _result = _execute.execute("VarHandleOp", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def var_is_initialized_op(resource, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [resource]
    _attrs = None
    _result = _execute.execute("VarIsInitializedOp", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
