...
def dense_to_dense_set_operation(set1, set2, set_operation, validate_indices=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([set1, set2])
    (set1, set2) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _inputs_flat = [set1, set2]
    _attrs = ("set_operation", set_operation, "validate_indices",
              validate_indices, "T", _attr_T)
    _result = _execute.execute("DenseToDenseSetOperation", 3,
...
def dense_to_sparse_set_operation(set1, set2_indices, set2_values, set2_shape, set_operation, validate_indices=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([set1, set2_values])
    (set1, set2_values) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    set2_indices = _tensor.convert_to_eager_tensor(set2_indices, _dtypes.int64)
    set2_shape = _tensor.convert_to_eager_tensor(set2_shape, _dtypes.int64)
    _inputs_flat = [set1, set2_indices, set2_values, set2_shape]
    _attrs = ("set_operation", set_operation, "validate_indices",
              validate_indices, "T", _attr_T)
    _result = _execute.execute("DenseToSparseSetOperation", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def set_size(set_indices, set_values, set_shape, validate_indices=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (set_values,) = _execute.args_to_matching_eager([set_values])
    _attr_T = _attr_T.as_datatype_enum
    set_indices = _tensor.convert_to_eager_tensor(set_indices, _dtypes.int64)
    set_shape = _tensor.convert_to_eager_tensor(set_shape, _dtypes.int64)
    _inputs_flat = [set_indices, set_values, set_shape]
    _attrs = ("validate_indices", validate_indices, "T", _attr_T)
    _result = _execute.execute("SetSize", 1, inputs=_inputs_flat,
...
def sparse_to_sparse_set_operation(set1_indices, set1_values, set1_shape, set2_indices, set2_values, set2_shape, set_operation, validate_indices=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([set1_values, set2_values])
    (set1_values, set2_values) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    set1_indices = _tensor.convert_to_eager_tensor(set1_indices, _dtypes.int64)
    set1_shape = _tensor.convert_to_eager_tensor(set1_shape, _dtypes.int64)
    set2_indices = _tensor.convert_to_eager_tensor(set2_indices, _dtypes.int64)
    set2_shape = _tensor.convert_to_eager_tensor(set2_shape, _dtypes.int64)
    _inputs_flat = [set1_indices, set1_values, set1_shape, set2_indices, set2_values, set2_shape]
    _attrs = ("set_operation", set_operation, "validate_indices",
              validate_indices, "T", _attr_T)
    _result = _execute.execute("SparseToSparseSetOperation", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
