...
def _add_many_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (sparse_values,) = _execute.args_to_matching_eager([sparse_values])
    _attr_T = _attr_T.as_datatype_enum
    sparse_indices = _tensor.convert_to_eager_tensor(sparse_indices, _dtypes.int64)
    sparse_shape = _tensor.convert_to_eager_tensor(sparse_shape, _dtypes.int64)
    _inputs_flat = [sparse_indices, sparse_values, sparse_shape]
    _attrs = ("T", _attr_T, "container", container, "shared_name",
              shared_name)
    _result = _execute.execute("AddManySparseToTensorsMap", 1,
...
def _add_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "container", container, "shared_name",
              shared_name)
    _result = _execute.execute("AddSparseToTensorsMap", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _deserialize_many_sparse(serialized_sparse, dtype, name=None):
  ...
  if _context.in_graph_mode():
    ...
    serialized_sparse = _tensor.convert_to_eager_tensor(serialized_sparse, _dtypes.string)
    _inputs_flat = [serialized_sparse]
    _attrs = ("dtype", dtype)
    _result = _execute.execute("DeserializeManySparse", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _serialize_many_sparse(sparse_indices, sparse_values, sparse_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [sparse_indices, sparse_values, sparse_shape]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SerializeManySparse", 1, inputs=_inputs_flat,
...
def _serialize_sparse(sparse_indices, sparse_values, sparse_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [sparse_indices, sparse_values, sparse_shape]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SerializeSparse", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_add(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([a_values, b_values])
    (a_values, b_values) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _attr_Treal, (thresh,) = _execute.args_to_matching_eager([thresh])
    _attr_Treal = _attr_Treal.as_datatype_enum
    a_indices = _tensor.convert_to_eager_tensor(a_indices, _dtypes.int64)
    a_shape = _tensor.convert_to_eager_tensor(a_shape, _dtypes.int64)
    b_indices = _tensor.convert_to_eager_tensor(b_indices, _dtypes.int64)
    b_shape = _tensor.convert_to_eager_tensor(b_shape, _dtypes.int64)
    _inputs_flat = [a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh]
    _attrs = ("T", _attr_T, "Treal", _attr_Treal)
    _result = _execute.execute("SparseAdd", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_add_grad(backprop_val_grad, a_indices, b_indices, sum_indices, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (backprop_val_grad,) = _execute.args_to_matching_eager([backprop_val_grad])
    _attr_T = _attr_T.as_datatype_enum
    a_indices = _tensor.convert_to_eager_tensor(a_indices, _dtypes.int64)
    b_indices = _tensor.convert_to_eager_tensor(b_indices, _dtypes.int64)
    sum_indices = _tensor.convert_to_eager_tensor(sum_indices, _dtypes.int64)
    _inputs_flat = [backprop_val_grad, a_indices, b_indices, sum_indices]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseAddGrad", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_concat(indices, values, shapes, concat_dim, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T = _attr_T.as_datatype_enum
    indices = _tensor.convert_n_to_eager_tensor(indices, _dtypes.int64)
    shapes = _tensor.convert_n_to_eager_tensor(shapes, _dtypes.int64)
    _inputs_flat = list(indices) + list(values) + list(shapes)
    _attrs = ("concat_dim", concat_dim, "N", _attr_N, "T", _attr_T)
    _result = _execute.execute("SparseConcat", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_cross(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_sparse_types, values = _execute.convert_to_mixed_eager_tensors(values)
    _attr_sparse_types = [_t.as_datatype_enum for _t in _attr_sparse_types]
    _attr_dense_types, dense_inputs = _execute.convert_to_mixed_eager_tensors(dense_inputs)
    ...
    _result = _execute.execute("SparseCross", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_dense_cwise_add(sp_indices, sp_values, sp_shape, dense, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([sp_values, dense])
    (sp_values, dense) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    sp_indices = _tensor.convert_to_eager_tensor(sp_indices, _dtypes.int64)
    sp_shape = _tensor.convert_to_eager_tensor(sp_shape, _dtypes.int64)
    _inputs_flat = [sp_indices, sp_values, sp_shape, dense]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseDenseCwiseAdd", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_dense_cwise_div(sp_indices, sp_values, sp_shape, dense, name=None):
  ...
  *Limitation*: this Op only broadcasts the dense side to the sparse side, but not
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [sp_indices, sp_values, sp_shape, dense]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseDenseCwiseDiv", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_dense_cwise_mul(sp_indices, sp_values, sp_shape, dense, name=None):
  ...
  *Limitation*: this Op only broadcasts the dense side to the sparse side, but not
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [sp_indices, sp_values, sp_shape, dense]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseDenseCwiseMul", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_fill_empty_rows(indices, values, dense_shape, default_value, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([values, default_value])
    ...
    _inputs_flat = [indices, values, dense_shape, default_value]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseFillEmptyRows", 4, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_fill_empty_rows_grad(reverse_index_map, grad_values, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (grad_values,) = _execute.args_to_matching_eager([grad_values])
    _attr_T = _attr_T.as_datatype_enum
    reverse_index_map = _tensor.convert_to_eager_tensor(reverse_index_map, _dtypes.int64)
    _inputs_flat = [reverse_index_map, grad_values]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseFillEmptyRowsGrad", 2,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_reduce_max(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (input_values,) = _execute.args_to_matching_eager([input_values])
    _attr_T = _attr_T.as_datatype_enum
    input_indices = _tensor.convert_to_eager_tensor(input_indices, _dtypes.int64)
    input_shape = _tensor.convert_to_eager_tensor(input_shape, _dtypes.int64)
    reduction_axes = _tensor.convert_to_eager_tensor(reduction_axes, _dtypes.int32)
    _inputs_flat = [input_indices, input_values, input_shape, reduction_axes]
    _attrs = ("keep_dims", keep_dims, "T", _attr_T)
    _result = _execute.execute("SparseReduceMax", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_reduce_max_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input_indices, input_values, input_shape, reduction_axes]
    _attrs = ("keep_dims", keep_dims, "T", _attr_T)
    _result = _execute.execute("SparseReduceMaxSparse", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_reduce_sum(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input_indices, input_values, input_shape, reduction_axes]
    _attrs = ("keep_dims", keep_dims, "T", _attr_T)
    _result = _execute.execute("SparseReduceSum", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_reduce_sum_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input_indices, input_values, input_shape, reduction_axes]
    _attrs = ("keep_dims", keep_dims, "T", _attr_T)
    _result = _execute.execute("SparseReduceSumSparse", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_reorder(input_indices, input_values, input_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input_indices, input_values, input_shape]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseReorder", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_reshape(input_indices, input_shape, new_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    input_indices = _tensor.convert_to_eager_tensor(input_indices, _dtypes.int64)
    input_shape = _tensor.convert_to_eager_tensor(input_shape, _dtypes.int64)
    new_shape = _tensor.convert_to_eager_tensor(new_shape, _dtypes.int64)
    _inputs_flat = [input_indices, input_shape, new_shape]
    _attrs = None
    _result = _execute.execute("SparseReshape", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_slice(indices, values, shape, start, size, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (values,) = _execute.args_to_matching_eager([values])
    _attr_T = _attr_T.as_datatype_enum
    indices = _tensor.convert_to_eager_tensor(indices, _dtypes.int64)
    shape = _tensor.convert_to_eager_tensor(shape, _dtypes.int64)
    start = _tensor.convert_to_eager_tensor(start, _dtypes.int64)
    size = _tensor.convert_to_eager_tensor(size, _dtypes.int64)
    _inputs_flat = [indices, values, shape, start, size]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseSlice", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_softmax(sp_indices, sp_values, sp_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (sp_values,) = _execute.args_to_matching_eager([sp_values])
    _attr_T = _attr_T.as_datatype_enum
    sp_indices = _tensor.convert_to_eager_tensor(sp_indices, _dtypes.int64)
    sp_shape = _tensor.convert_to_eager_tensor(sp_shape, _dtypes.int64)
    _inputs_flat = [sp_indices, sp_values, sp_shape]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseSoftmax", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_sparse_maximum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [a_indices, a_values, a_shape, b_indices, b_values, b_shape]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseSparseMaximum", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def sparse_sparse_minimum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [a_indices, a_values, a_shape, b_indices, b_values, b_shape]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("SparseSparseMinimum", 2, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_split(split_dim, indices, values, shape, num_split, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, (values,) = _execute.args_to_matching_eager([values])
    _attr_T = _attr_T.as_datatype_enum
    split_dim = _tensor.convert_to_eager_tensor(split_dim, _dtypes.int64)
    indices = _tensor.convert_to_eager_tensor(indices, _dtypes.int64)
    shape = _tensor.convert_to_eager_tensor(shape, _dtypes.int64)
    _inputs_flat = [split_dim, indices, values, shape]
    _attrs = ("num_split", num_split, "T", _attr_T)
    _result = _execute.execute("SparseSplit", num_split + num_split +
...
def _sparse_tensor_dense_add(a_indices, a_values, a_shape, b, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([a_values, b])
    (a_values, b) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _attr_Tindices, _inputs_Tindices = _execute.args_to_matching_eager([a_indices, a_shape])
    (a_indices, a_shape) = _inputs_Tindices
    _attr_Tindices = _attr_Tindices.as_datatype_enum
    _inputs_flat = [a_indices, a_values, a_shape, b]
    _attrs = ("T", _attr_T, "Tindices", _attr_Tindices)
    _result = _execute.execute("SparseTensorDenseAdd", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_tensor_dense_mat_mul(a_indices, a_values, a_shape, b, adjoint_a=False, adjoint_b=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    (a_values, b) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _attr_Tindices, (a_indices,) = _execute.args_to_matching_eager([a_indices], _dtypes.int64)
    _attr_Tindices = _attr_Tindices.as_datatype_enum
    a_shape = _tensor.convert_to_eager_tensor(a_shape, _dtypes.int64)
    _inputs_flat = [a_indices, a_values, a_shape, b]
    _attrs = ("T", _attr_T, "Tindices", _attr_Tindices, "adjoint_a",
              adjoint_a, "adjoint_b", adjoint_b)
    _result = _execute.execute("SparseTensorDenseMatMul", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _sparse_to_dense(sparse_indices, output_shape, sparse_values, default_value, validate_indices=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([sparse_values, default_value])
    (sparse_values, default_value) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    _attr_Tindices, _inputs_Tindices = _execute.args_to_matching_eager([sparse_indices, output_shape])
    (sparse_indices, output_shape) = _inputs_Tindices
    _attr_Tindices = _attr_Tindices.as_datatype_enum
    _inputs_flat = [sparse_indices, output_shape, sparse_values, default_value]
    _attrs = ("validate_indices", validate_indices, "T", _attr_T, "Tindices",
              _attr_Tindices)
    _result = _execute.execute("SparseToDense", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _take_many_sparse_from_tensors_map(sparse_handles, dtype, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    sparse_handles = _tensor.convert_to_eager_tensor(sparse_handles, _dtypes.int64)
    _inputs_flat = [sparse_handles]
    _attrs = ("dtype", dtype, "container", container, "shared_name",
              shared_name)
    _result = _execute.execute("TakeManySparseFromTensorsMap", 3,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
