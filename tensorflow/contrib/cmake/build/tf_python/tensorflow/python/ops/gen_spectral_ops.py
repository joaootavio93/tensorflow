...
def _batch_fft(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    input = _tensor.convert_to_eager_tensor(input, _dtypes.complex64)
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("BatchFFT", 1, inputs=_inputs_flat,
...
def _batch_fft2d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("BatchFFT2D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_fft3d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("BatchFFT3D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_ifft(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("BatchIFFT", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_ifft2d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("BatchIFFT2D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _batch_ifft3d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("BatchIFFT3D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def fft(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("FFT", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def fft2d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("FFT2D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def fft3d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("FFT3D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def ifft(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("IFFT", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def ifft2d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("IFFT2D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def ifft3d(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("IFFT3D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def irfft(input, fft_length, name=None):
  ...
  if _context.in_graph_mode():
    ...
    input = _tensor.convert_to_eager_tensor(input, _dtypes.complex64)
    fft_length = _tensor.convert_to_eager_tensor(fft_length, _dtypes.int32)
    _inputs_flat = [input, fft_length]
    _attrs = None
    _result = _execute.execute("IRFFT", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def irfft2d(input, fft_length, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input, fft_length]
    _attrs = None
    _result = _execute.execute("IRFFT2D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def irfft3d(input, fft_length, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input, fft_length]
    _attrs = None
    _result = _execute.execute("IRFFT3D", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def rfft(input, fft_length, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input, fft_length]
    _attrs = None
    _result = _execute.execute("RFFT", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def rfft2d(input, fft_length, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input, fft_length]
    _attrs = None
    _result = _execute.execute("RFFT2D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
...
def rfft3d(input, fft_length, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input, fft_length]
    _attrs = None
    _result = _execute.execute("RFFT3D", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
