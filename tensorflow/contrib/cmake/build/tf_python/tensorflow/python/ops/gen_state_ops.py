...
def assign_add(ref, value, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "assign_add op does not support eager execution.")
  _result = _execute.record_gradient(
...
def assign_sub(ref, value, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "assign_sub op does not support eager execution.")
  _result = _execute.record_gradient(
...
def count_up_to(ref, limit, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "count_up_to op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _destroy_temporary_variable(ref, var_name, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "destroy_temporary_variable op does not support eager execution.")
  _result = _execute.record_gradient(
...
def is_variable_initialized(ref, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "is_variable_initialized op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_add(ref, indices, updates, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_add op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_div(ref, indices, updates, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_div op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_mul(ref, indices, updates, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_mul op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_nd_add(ref, indices, updates, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_nd_add op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_nd_sub(ref, indices, updates, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_nd_sub op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_nd_update(ref, indices, updates, use_locking=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_nd_update op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_sub(ref, indices, updates, use_locking=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_sub op does not support eager execution.")
  _result = _execute.record_gradient(
...
def scatter_update(ref, indices, updates, use_locking=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "scatter_update op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _temporary_variable(shape, dtype, var_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "temporary_variable op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _variable(shape, dtype, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "variable op does not support eager execution.")
  _result = _execute.record_gradient(
...
def _variable_v2(shape, dtype, container="", shared_name="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    raise RuntimeError(
        "variable_v2 op does not support eager execution.")
  _result = _execute.record_gradient(
