...
def as_string(input, precision=-1, scientific=False, shortest=False, width=-1, fill="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("AsString", 1, inputs=_inputs_flat,
...
def decode_base64(input, name=None):
  ...
  if _context.in_graph_mode():
    ...
    input = _tensor.convert_to_eager_tensor(input, _dtypes.string)
    _inputs_flat = [input]
    _attrs = None
    _result = _execute.execute("DecodeBase64", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def encode_base64(input, pad=False, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("pad", pad)
    _result = _execute.execute("EncodeBase64", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def reduce_join(inputs, reduction_indices, keep_dims=False, separator="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    inputs = _tensor.convert_to_eager_tensor(inputs, _dtypes.string)
    reduction_indices = _tensor.convert_to_eager_tensor(reduction_indices, _dtypes.int32)
    _inputs_flat = [inputs, reduction_indices]
    _attrs = ("keep_dims", keep_dims, "separator", separator)
    _result = _execute.execute("ReduceJoin", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def string_join(inputs, separator="", name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("StringJoin", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def _string_split(input, delimiter, skip_empty=True, name=None):
  ...
  if _context.in_graph_mode():
    ...
    input = _tensor.convert_to_eager_tensor(input, _dtypes.string)
    delimiter = _tensor.convert_to_eager_tensor(delimiter, _dtypes.string)
    _inputs_flat = [input, delimiter]
    _attrs = ("skip_empty", skip_empty)
    _result = _execute.execute("StringSplit", 3, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def string_to_hash_bucket(string_tensor, num_buckets, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("StringToHashBucket", 1, inputs=_inputs_flat,
                               attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def string_to_hash_bucket_fast(input, num_buckets, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _inputs_flat = [input]
    _attrs = ("num_buckets", num_buckets)
    _result = _execute.execute("StringToHashBucketFast", 1,
...
def string_to_hash_bucket_strong(input, num_buckets, key, name=None):
  ...
  if _context.in_graph_mode():
    ...
    _result = _execute.execute("StringToHashBucketStrong", 1,
                               inputs=_inputs_flat, attrs=_attrs, name=name)
  _result = _execute.record_gradient(
...
def substr(input, pos, len, name=None):
  ...
  *NOTE*: `Substr` supports broadcasting up to two dimensions. More about
  ...
  if _context.in_graph_mode():
    ...
    _attr_T, _inputs_T = _execute.args_to_matching_eager([pos, len])
    (pos, len) = _inputs_T
    _attr_T = _attr_T.as_datatype_enum
    input = _tensor.convert_to_eager_tensor(input, _dtypes.string)
    _inputs_flat = [input, pos, len]
    _attrs = ("T", _attr_T)
    _result = _execute.execute("Substr", 1, inputs=_inputs_flat, attrs=_attrs,
                               name=name)
  _result = _execute.record_gradient(
