...
def TFE_DeleteTensorHandle(h):
    return _pywrap_tensorflow_internal.TFE_DeleteTensorHandle(h)
TFE_DeleteTensorHandle = _pywrap_tensorflow_internal.TFE_DeleteTensorHandle

def TFE_TensorHandleDataType(h):
    return _pywrap_tensorflow_internal.TFE_TensorHandleDataType(h)
TFE_TensorHandleDataType = _pywrap_tensorflow_internal.TFE_TensorHandleDataType

def TFE_TensorHandleNumDims(h):
    return _pywrap_tensorflow_internal.TFE_TensorHandleNumDims(h)
TFE_TensorHandleNumDims = _pywrap_tensorflow_internal.TFE_TensorHandleNumDims

def TFE_TensorHandleDim(h, dim_index):
    return _pywrap_tensorflow_internal.TFE_TensorHandleDim(h, dim_index)
TFE_TensorHandleDim = _pywrap_tensorflow_internal.TFE_TensorHandleDim

def TFE_TensorHandleDeviceName(h):
    return _pywrap_tensorflow_internal.TFE_TensorHandleDeviceName(h)
TFE_TensorHandleDeviceName = _pywrap_tensorflow_internal.TFE_TensorHandleDeviceName

def TFE_TensorHandleCopyToDevice(h, ctx, device_name, status):
    return _pywrap_tensorflow_internal.TFE_TensorHandleCopyToDevice(h, ctx, device_name, status)
TFE_TensorHandleCopyToDevice = _pywrap_tensorflow_internal.TFE_TensorHandleCopyToDevice
...
def TFE_Py_TensorHandleToNumpy(h, status):
    return _pywrap_tensorflow_internal.TFE_Py_TensorHandleToNumpy(h, status)
TFE_Py_TensorHandleToNumpy = _pywrap_tensorflow_internal.TFE_Py_TensorHandleToNumpy

def TFE_Py_NumpyToTensorHandle(obj):
    return _pywrap_tensorflow_internal.TFE_Py_NumpyToTensorHandle(obj)
TFE_Py_NumpyToTensorHandle = _pywrap_tensorflow_internal.TFE_Py_NumpyToTensorHandle
